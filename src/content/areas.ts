...
const BASE_AREAS: AreaConfig[] = [
  {
    ...
    faqs: [
      ...
      { q: "Is there parking if I prefer to drop off in person?", a: "Yes, paid parking inside Concord Tower. From Marina, drive 10 minutes north on Sheikh Zayed Road and exit at Media City. Free street parking on Al Sufouh Road behind the tower." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "My MacBook fell on the sand at JBR Beach. Can you save it?", a: "Likely yes. Sand inside vents and ports causes overheating but rarely permanent damage. Bring it in within 24 hours; we strip-clean fans, heatsinks and ports, replace any pitted keys, and run a full diagnostic. Message us on WhatsApp for today's exact price on your model." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What if we'd rather drop off in person?", a: "Concord Tower is a 3 to 5 minute drive - exit at Media City off Sheikh Zayed Road. Paid parking inside the tower and free street parking on Al Sufouh Road behind it." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What if I'd rather drop off in person from Deira?", a: "Concord Tower, Media City is about 25 minutes by taxi from Deira City Centre. Paid parking inside the tower. We can also arrange a drop-off at Union Metro if that's easier." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What if I prefer to drop it off from Bur Dubai?", a: "Concord Tower is a 20-minute drive. Paid parking inside. BurJuman Metro is also close if you prefer public transport." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Is there a drop-off option if I'd prefer to come to you?", a: "Yes. Concord Tower is 15 minutes from the Palm gateway by car. Paid parking inside. Many Palm residents drop off on their way to Media City or Sheikh Zayed Road." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Can I drop off in person since you're close?", a: "Yes. Concord Tower is 8 minutes from Mall of the Emirates. Many Barsha residents walk or drive the MacBook over. Paid parking inside." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "I'd rather drop it off in person - where exactly are you?", a: "Concord Tower, Dubai Media City, on Al Sufouh Road - a 4-5 minute drive from most of Al Sufouh. Paid parking inside the tower and free street parking on Al Sufouh Road behind it." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What's the nearest Metro if I'd rather come in person?", a: "Dubai Internet City Metro is the closest stop. By car, Concord Tower is a 9-minute drive via Sheikh Zayed Road and Al Sufouh Road. Paid parking inside." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What's the nearest Metro if I'd rather come in person?", a: "Discovery Gardens Metro serves the community directly. By car, Concord Tower in Media City is a 15-minute drive via Sheikh Zayed Road. Paid parking inside." },
