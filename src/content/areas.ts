...
export const AREAS: AreaConfig[] = [
  ...
  },
  {
    ...
    intro:
      "Jumeirah Beach Residence (JBR) is one of the closest residential clusters to our Media City workshop - only 8 minutes by car along Al Sufouh Road, or two tram stops + a short Metro ride. We collect MacBooks free of charge from any JBR tower (Rimal, Bahar, Sadaf, Shams, Amwaj, Murjan), deliver back the same day, and provide a written 12-month warranty. Most JBR pickups are completed within 30 minutes of WhatsApp confirmation, often faster during the courier's morning loop along The Walk.",
    whyChoose:
    ...
    faqs: [
      ...
      { q: "Do you sell pre-owned MacBooks for JBR holiday-let landlords?", a: "Yes - refurbished, certified, with a 12-month warranty. Useful for serviced apartments. WhatsApp for current stock and pricing." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Do you sell refurbished MacBooks for the school-run-and-back-up family setup?", a: "Yes - certified refurbished MacBook Air and Pro models with a 12-month warranty, delivered to your villa for inspection. Pay only if you keep it." },
  ...
  },
  {
    ...
    intro:
      "Jumeirah Lakes Towers (JLT) is one of the closest commercial-residential clusters to our workshop - 8 minutes by car or 3 Metro stops from DMCC to Media City. We collect MacBooks free of charge from any JLT tower (Almas, Lake Shore, Indigo, Saba, Goldcrest, Armada, Mag 214, Lake Terrace), deliver back the same day, and provide a written 12-month warranty. Most JLT pickups are completed within 30 minutes of WhatsApp confirmation, and the courier covers all 26 JLT clusters daily.",
    whyChoose:
  ...
  },
  {
    ...
    intro:
      "Dubai Silicon Oasis (DSO) - Silicon Gate, Silicon Avenue, Cedre Villas, the Choithrams cluster, the universities - is 30 minutes from our Media City workshop via Sheikh Mohammed Bin Zayed Road. We collect MacBooks free of charge from any Silicon Oasis address, deliver back the same or next morning, and provide a written 12-month warranty. The courier runs a Silicon Oasis loop most weekday afternoons, so pickup is same-day if you message us before 2 pm.",
    whyChoose:
    ...
    faqs: [
      ...
      { q: "Are you cheaper than the Apple Service Centre in Festival City?", a: "Roughly 40-60% cheaper for screen, battery and board repairs, with the same 12-month warranty and genuine or OEM-grade parts. Walk-in transparent pricing - no 'minimum service charge'." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Is the 12-month warranty valid for Deira customers?", a: "Yes, the same 12-month written warranty applies regardless of where in the UAE you are." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Is the 12-month warranty the same for Bur Dubai customers?", a: "Yes. Same warranty, same parts quality, same technicians regardless of where in Dubai you are." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What warranty do Karama customers get?", a: "Same 12-month written warranty as every other customer. If the same fault returns within 12 months, we fix it at no charge." },
  ...
  },
  {
    ...
    short: "Barsha",
    driveTime: "8 minutes",
    metroNote: "Mall of the Emirates Metro on the Red Line is 4 minutes from the workshop — Al Barsha is the closest major residential area to the workshop.",
    pickupWindow: "Within 20 minutes",
    landmarks: ["Mall of the Emirates", "Barsha Pond Park", "Al Barsha 1 / 2 / 3", "Barsha Heights (Tecom)", "Gems schools cluster", "Al Barsha South"],
    landmarkLine: "8 minutes from Mall of the Emirates, Barsha Pond Park, and all Al Barsha 1, 2, and 3 communities.",
    intro:
      "Al Barsha is the closest major residential district to the MacBook Repair Dubai workshop in Concord Tower, Media City — just 8 minutes away. From Al Barsha 1 apartments near Mall of the Emirates to Barsha Heights (Tecom) offices and Al Barsha South villas, we cover every Barsha address with the fastest pickup on our entire service map. Most Al Barsha residents have their MacBook back the same morning.",
    whyChoose:
      "Al Barsha is practically on our doorstep. The courier is typically with you within 20 minutes of the WhatsApp confirmation — faster than driving to any service centre in the city. We collect from the apartment blocks along Sheikh Zayed Road frontage, the Gems schools back-offices, Barsha Heights co-working spaces, and Al Barsha South villas. Written quote before we start. 12-month warranty after. Free pickup and delivery both ways.",
    pickupNote:
      "WhatsApp Shafiq on 055 741 3706 with your building name (e.g. 'Al Barsha 1, near Mall of the Emirates' or 'Barsha Heights, Tecom cluster') and MacBook model. The courier confirms within 3 minutes and is usually with you in 20 minutes. Al Barsha is our fastest pickup zone.",
    travel: [
      ...
      { from: "Barsha Heights (Tecom)",               drive: "6 min",  pickup: "Within 15 min" },
    ...
    topServices: COMMON_SERVICES,
    faqs: [
      { q: "How fast is pickup from Al Barsha?", a: "Al Barsha is our closest residential zone — typically 15-20 minutes from WhatsApp confirmation. Barsha Heights (Tecom) is even faster at 10-15 minutes because it borders Media City." },
      { q: "Do you cover Barsha Heights (Tecom) offices?", a: "Yes, Barsha Heights is practically next door. We cover every Tecom office building and collect from the reception or IT desk, same-day return on stock parts." },
      ...
      { q: "Is same-day service guaranteed from Al Barsha?", a: "Yes for screen, battery, keyboard, and trackpad repairs. Collect by 11 am, back by 4 pm is standard. We have the fastest turnaround of any Dubai district." },
      { q: "Do you cover Al Barsha South and Al Barsha 3?", a: "Yes. All Al Barsha zones (1, 2, 3, South, and Barsha Heights) are in our free pickup zone. Al Barsha South is 12 minutes and we collect there daily." },
