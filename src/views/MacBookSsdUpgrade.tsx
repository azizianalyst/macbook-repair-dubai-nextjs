  ...
  return (
    <SubServicePageTemplate
      ...
      faqs={[
        ...
        { q: "What about external Thunderbolt 4 SSDs as a workaround?", a: "Genuinely good. A Samsung T9 or OWC Envoy Pro on Thunderbolt 4 (40 Gbps) reaches 3,000+ MB/s - within 30% of the internal SSD speed and indistinguishable for most workloads. We set these up as boot drives or scratch volumes for a small flat fee." },
