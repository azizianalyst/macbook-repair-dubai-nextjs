...
export default function BlogIPadWaterDamageRepair() {
  return (
    <BlogPostTemplate
      ...
      seoDescription="iPad water damage repair Dubai: AED 450–1,400 depending on board damage. First 30 minutes matter most. 80% recovery rate. Free pickup, 12-month warranty."
      ...
      body={
        <>
          <h2>The most important thing — do this in the first 30 minutes</h2>
          <p>
          ...
          <h2>iPad water damage repair pricing — Dubai 2026</h2>
          <BlogPriceTable
          ...
          <h2>Fresh water vs salt water vs pool water — why it matters</h2>
          <p>
          ...
          <h2>Is it worth repairing? Repair vs replace guide</h2>
          <p>
          ...
          <h2>How to get same-day water damage repair in Dubai</h2>
          <p>
            WhatsApp Shafiq on <a href="https://wa.me/971557413706" className="text-accent hover:underline">055 741 3706</a> the
