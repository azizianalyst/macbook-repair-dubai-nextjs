...
export default function MacBookProM2BatteryReplacement() {
  return (
    <MacBookProChipBatteryPage
      ...
      faults={[
        ...
        },
        {
          ...
          body: "The M2 Pro is an efficient chip but sustained Xcode builds, video exports, or machine learning tasks can deplete the 69.6 Wh cell quickly. If runtime has dropped from the expected 17 hours to under 10 hours, the cell is degraded and needs replacement.",
        },
        {
          title: "M2 256GB SSD drain vs battery fault — how to tell",
          body: "Some M2 Pro models with 256GB SSDs write to flash more aggressively, keeping the SSD active and raising background power consumption. This can mimic battery fault symptoms. We diagnose both during the free health check so you know whether the cell or the SSD activity is causing the drain before you pay anything.",
        },
        {
          title: "M2 Pro not charging past 80 percent",
          body: "With Optimized Charging disabled, stalling at 80 percent indicates cell voltage variance. The BMS is protecting the weakest cell in the pouch. Battery replacement plus BMS re-pair resolves this completely. Free health check confirms before work begins.",
        },
        {
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Some M2 MacBook Pro models with a 256GB SSD have higher background SSD write activity that increases power draw, which can look like a battery fault. During our free health check we measure both the actual cell capacity and background power consumption so you know the real cause before any work is done.",
        },
        {
          q: "What is BMS re-pair and why does the M2 Pro need it?",
          a: "BMS (Battery Management System) re-pair programs the new cell's chemistry data into the MacBook Pro's System Management Controller so macOS accurately reports capacity, cycle count, and charge status. Without it, readings are invalid and Optimized Charging does not function. All M2 and newer Apple Silicon Pros require this step. It is included in our price.",
        },
        {
