...
export default function IPhoneHeadphoneJackRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone Headphone Jack Repair Dubai | iPhone 6S and Earlier"
      seoDescription="iPhone 3.5mm headphone jack repair Dubai. Lint clean often free. iPhone 6S and earlier only - newer models have no jack. Same day. WhatsApp for a quote."
      path="/iphone-headphone-jack-repair-dubai"
      eyebrow="iPhone headphone jack"
      h1="iPhone Headphone Jack Repair Dubai"
      subtitle={'Stuck headphone tip, dead audio, or "headphones plugged in" stuck on. iPhone 6S and earlier only - Apple removed the jack from iPhone 7 onwards. Same day. Message us for today\'s price.'}
      startingPrice={200}
      timeline="Same day"
      ...
      intro={
        <>
          <p className="text-[18px] leading-relaxed mb-md">
            <strong>Quick honesty:</strong> if you have an iPhone 7 or newer, your phone never had a headphone jack - Apple removed it. Use the Lightning-to-3.5mm or USB-C-to-3.5mm adapter (we sell genuine ones, or buy from Apple). This page is for iPhone 6S, 6, SE 1st gen, and earlier - the last iPhones with a true 3.5mm jack.
          </p>
          <p className="text-[16px] text-text-muted leading-relaxed">
            Most "broken jack" cases on these older iPhones are pocket lint packed deep into the socket - we extract for free. About 30% need a new jack assembly because the spring contacts have worn or a snapped headphone tip is wedged inside. Same day on the full replacement - message us on WhatsApp for today's price on your model.
          </p>
        </>
      }
      whatWeFix={[
      ...
      faqs={[
        ...
        { q: "Should I just buy an adapter for a newer iPhone?", a: "Yes - Apple's Lightning or USB-C to 3.5mm adapter is the simplest path. Genuine adapters work perfectly with no hardware risk; message us if you'd like one." },
