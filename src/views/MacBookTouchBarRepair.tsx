...
export default function MacBookTouchBarRepair() {
  return (
    <SubServicePageTemplate
      ...
      subtitle="Dead strip, flickering, half the bar lit, or ghost taps firing on their own. The Touch Bar is replaceable on every 2016-2022 Pro that has one. Most jobs done in 1-2 days."
      startingPrice={600}
      timeline="1-2 days"
      ...
      steps={[
        ...
        { title: "Quote on WhatsApp", body: "Written price before a screwdriver moves. Most Touch Bar jobs are a straight strip replacement; board-level controller faults are quoted separately." },
      ...
      faqs={[
        ...
        { q: "How much does Touch Bar repair cost in Dubai?", a: "The strip replacement on the 13″ and 15″ Pro is one flat quoted job, parts and labour included, VAT-inclusive. If the fault is the Touch Bar controller on the logic board rather than the strip itself, that's a board-level repair and we quote it after diagnosis - usually still under what Apple charges for a full top-case swap." },
      ...
      related={[
        { label: "MacBook Keyboard Repair",   href: "/macbook-keyboard-repair-dubai",   description: "Full deck replacement, quoted per model." },
