...
export default function MacBookLogicBoardRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="MacBook Logic Board Repair Dubai - Component-Level | From AED 299"
      seoDescription="MacBook logic board repair Dubai. Component-level rework - IC swap, PMIC, CPU reflow, charging circuit. Not board-swap. From AED 299. Call 055 741 3706."
      ...
      subtitle="Failed PMIC, dead charging circuit, blown MOSFET, CPU reflow. We replace the failed chip - not the whole board. From AED 299, 3-5 days."
      startingPrice={299}
      timeline="3-5 days"
      ...
      faqs={[
        ...
        { q: "Have you fixed liquid-damaged boards before?", a: "Hundreds. Liquid often kills one specific chip (because it shorted a particular rail) and the rest of the board is fine. We isolate, replace, ultrasonic clean. AED 299-1,500 typical." },
      ]}
      ...
      related={[
        ...
        { label: "MacBook Water Damage Repair", href: "/macbook-water-damage-repair-dubai",     description: "Sister fault - liquid kills boards. From AED 299." },
        { label: "MacBook GPU Repair",          href: "/macbook-gpu-repair-dubai",              description: "Discrete GPU faults on 2016-2019 Intel. AED 299." },
      ]}
