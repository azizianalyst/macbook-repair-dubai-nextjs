...
export default function MacBookCleaningMaintenance() {
  return (
    <SubServicePageTemplate
      ...
      seoDescription="MacBook cleaning and maintenance in Dubai. Dust and corrosion removal, fan and vent clean, free pickup, warranty of up to 12 months. Call 055 741 3706."
      path="/macbook-cleaning-maintenance-dubai"
      eyebrow="MacBook cleaning & maintenance"
      h1="MacBook Cleaning and Maintenance in Dubai"
      subtitle="Dust builds up fast in Dubai. A full internal and external clean clears the fans, vents and ports, checks thermals, and keeps your MacBook running cool. Same day."
      startingPrice={280}
      timeline="Same day"
      ...
      intro={
        <>
          <p className="text-[18px] leading-relaxed mb-md">
            <strong>MacBook cleaning and maintenance at MacBook Repair Dubai</strong> is a full internal and external service: we open the chassis, clear dust and debris from the heatsink and fan blades, clean the vents and ports, wipe down the keyboard and screen, and check for early corrosion before it spreads. Dubai's heat, fine sand and humidity push dust into a MacBook faster than most cities, and that dust is the main reason fans run loud and chips run hot. Diagnosis is free, and the clean is quoted before it starts.
          </p>
      ...
      steps={[
        { title: "Book on WhatsApp or free pickup", body: "Message us the model and we arrange a slot, or collect the MacBook free across Dubai mainland. Pickup to Sharjah and Abu Dhabi carries a trip charge, confirmed before we dispatch." },
        { title: "Free inspection", body: "We open the machine, check dust levels, fan condition and any corrosion, and confirm the clean is all you need before any work starts." },
      ...
      faqs={[
        { q: "How much does a MacBook clean and service cost?", a: "A full internal and external clean is quoted VAT-inclusive at our Concord Tower workshop in Dubai Media City. That covers dust removal from the fans and heatsink, port cleaning, a thermal check and a macOS health review. If we spot a separate fault like a worn battery, we quote that before touching it - no surprises." },
        { q: "How often should I clean my MacBook in Dubai?", a: "Once a year is the right cycle for most people in Dubai, where fine sand and humidity load the fans faster than cooler climates. If you work outdoors, near a building site, or notice the fans running loud at idle, every 6 to 9 months is better. The clean takes a day, so it's cheap insurance against a thermal-related logic-board fault." },
        ...
        { q: "Do you collect the MacBook, or do I bring it in?", a: "Both. We offer free pickup and delivery across Dubai mainland - Marina, JLT, Business Bay, Downtown, Al Barsha and the rest. Pickup to Sharjah and Abu Dhabi carries a trip charge, confirmed before we dispatch. Or drop it at Concord Tower, Dubai Media City, where there's free parking. WhatsApp 055 741 3706 to arrange a slot." },
        ...
        { q: "Can you service older or vintage MacBooks?", a: "Yes. We service every MacBook from the 2012 Pro onward, including the 2015 to 2019 models that Apple now treats as vintage and won't touch. Older machines benefit the most from a clean and fresh thermal paste, since years of Dubai dust and dried paste are usually why they run hot and loud. The service costs the same regardless of age." },
        { q: "Will cleaning fix a MacBook that keeps shutting down?", a: "Often, yes - random shutdowns under load are frequently a thermal problem from clogged fans and old paste. We diagnose for free first. If the clean and re-paste solves it, that's all you pay. If the shutdown is a battery or logic-board fault instead, we'll show you the evidence and quote the actual repair before doing anything." },
      ]}
      ...
      related={[
        ...
        { label: "MacBook Water Damage Repair",   href: "/macbook-water-damage-repair-dubai",   description: "Spilled liquid? Full clean and corrosion treatment." },
        { label: "MacBook Overheating Fix",       href: "/macbook-overheating-fix-dubai",       description: "Already throttling or shutting down? Thermal paste and deep clean." },
      ]}
      quickAnswer={{
        question: "How much is a MacBook clean and service in Dubai?",
        answer: "A full internal and external MacBook clean is carried out at MacBook Repair Dubai in Concord Tower, Dubai Media City. It covers dust removal from the fans and heatsink, port cleaning, a thermal check and a macOS health review, with free diagnosis and a warranty of up to 12 months. Most jobs are done the same day, with free pickup across Dubai mainland.",
      }}
    />
  );
}
