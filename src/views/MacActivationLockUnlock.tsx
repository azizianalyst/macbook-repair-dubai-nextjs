...
export default function MacActivationLockUnlock() {
  return (
    <SubServicePageTemplate
      ...
      seoDescription="Mac & MacBook Activation Lock, iCloud lock and EFI firmware password help in Dubai. Legitimate owners only - we assist through Apple's channels, never a bypass. Message us on WhatsApp for a quote."
      ...
      subtitle="Locked out of your own Mac? Activation Lock, a forgotten Apple ID, or an EFI firmware password on an older Intel Mac. We help legitimate owners recover access through Apple - we do not bypass, and we'll prove that to you. Message us on WhatsApp for a quote."
      startingPrice={250}
      ...
      intro={
        <>
          <p className="text-[18px] leading-relaxed mb-md">
            If it's genuinely your Mac, we can help you get back into it. <strong>We only help real owners</strong>, and we'll ask you to prove it - that's the line we don't cross, and it's the line that protects you when you buy second-hand too. There are two different locks people in Dubai bring us. The first is <strong>Activation Lock</strong> (iCloud lock) on Apple Silicon and T2 Macs, tied to your Apple ID and enforced by Apple's servers. The second is an <strong>EFI firmware password</strong> on older Intel Macs, set in Recovery and asked for at a padlock screen on boot. Neither can be legitimately bypassed on modern hardware. What we do instead is prepare your ownership documents and work with Apple's official channels to recover access. Message us on WhatsApp for a quote, and if Apple refuses despite valid proof, you get the service fee back.
          </p>
      ...
      faqs={[
        ...
        { q: "How much does Mac unlock help cost in Dubai?", a: "It depends on the case - forgotten Apple ID recovery help, inherited Macs via Apple Estate, and second-hand ownership disputes that need an Apple liaison request each carry a different fee. Message us on WhatsApp with your situation for an exact, VAT-inclusive quote. You pay for the service time and Apple liaison, not for a guaranteed unlock - and if Apple refuses valid documentation, the fee comes back." },
        { q: "I inherited a Mac from a family member - can you help?", a: "Yes, through Apple's Estate / Digital Legacy process. Apple needs a death certificate, a court order naming you as executor, and the Mac itself. They review inheritance cases individually, usually over 2 to 4 weeks. We prepare and submit the documentation and chase Apple on your behalf. Message us on WhatsApp for a quote on the liaison work." },
