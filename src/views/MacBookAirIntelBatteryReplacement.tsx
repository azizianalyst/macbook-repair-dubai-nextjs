...
export default function MacBookAirIntelBatteryReplacement() {
  return (
    <MacBookAirChipBatteryPage
      ...
      chipUniquePoints={[
        ...
        "Apple has declared the 2017 and earlier Intel Air models obsolete in most markets. The 2018, 2019, and 2020 models are still serviceable at Apple but stock priority goes to newer devices. MacBook Repair Dubai carries new 49.9 Wh cells for all Intel Air models from 2018 to 2020 from tier-1 (Samsung SDI / LG Chem) manufacturers.",
        "Intel MacBook Air batteries do not require BMS firmware re-pair after replacement, unlike Apple Silicon models. The battery connector simply re-pairs via the charging cycle. This makes Intel Air battery swaps straightforward once the adhesive is removed.",
        "Dubai heat is especially hard on these older cells. Intel Air batteries kept in hot cars or on desks in direct sunlight in UAE summers can drop from 80% to 60% capacity in a single season. If your Intel Air barely lasts 3 hours, the cell is likely at 50–60% and replacement restores full 12-hour rated life.",
      ]}
      prices={[
        {
          model: 'MacBook Air 13" Intel (2018)',
          price: 450,
          applePrice: null,
          timeline: "Same day · 2 hours",
          l4href: "/macbook-air-13-intel-2018-repair-dubai",
        },
        {
          model: 'MacBook Air 13" Intel (2019)',
          price: 450,
          applePrice: null,
          timeline: "Same day · 2 hours",
          l4href: "/macbook-air-13-intel-2019-repair-dubai",
        },
        {
          model: 'MacBook Air 13" Intel (2020)',
          price: 450,
          applePrice: null,
          timeline: "Same day · 2 hours",
          l4href: "/macbook-air-13-intel-2020-repair-dubai",
        },
      ]}
      faults={[
        {
        ...
        },
        {
          ...
          body: "Heat above 35°C permanently degrades lithium-ion capacity. Intel Airs used in non-air-conditioned spaces or left in cars lose capacity 2–3x faster than in controlled environments. If capacity is below 80%, replacement restores full life.",
        },
        {
          title: "macOS shows battery health stuck at 100% but life is short",
          body: "Firmware quirk on Intel Macs running Ventura or Sonoma. The reading is cached. Use coconutBattery or Coconut Battery app to get the real cycle count and design capacity. Above 900 cycles with short life = replacement.",
        },
        {
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Apple services the 2018, 2019, and 2020 Intel Air but stock and priority are lower than for current models. The 2017 and earlier Intel Air is officially obsolete and Apple will not service it. MacBook Repair Dubai carries new cells for all Intel Air models from 2018 to 2020 and repairs them same-day.",
        },
        {
          q: "How do I check my Intel MacBook Air battery health?",
          a: "Hold Option and click the battery icon in the menu bar — it shows Normal, Service Recommended, or Service Battery. For cycle count and exact capacity, go to Apple menu > About This Mac > System Report > Power. Or use the free coconutBattery app for a clear reading.",
        },
        {
          q: "How long does MacBook Air Intel battery replacement take?",
          a: "Same-day 2-hour service at MacBook Repair Dubai. We carry 49.9 Wh Intel Air cells in stock. Drop off before 11am, collect by 1pm.",
        },
        {
      ...
      l3href="/macbook-air-intel-repair-dubai"
      l3label="MacBook Air Intel Repair Dubai"
    />
  );
}
