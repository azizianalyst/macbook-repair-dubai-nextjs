      ...
      intro={
        <>
          ...
          <ul className="space-y-1 text-[15px] mb-lg">
            <li>• <strong>Released:</strong> March 2022</li>
            <li>• <strong>Chip:</strong> Apple A15 Bionic (4 GB RAM)</li>
            <li>• <strong>Display:</strong> 4.7-inch Retina LCD, 1334 × 750</li>
            <li>• <strong>Connector:</strong> Lightning · 5G sub-6 GHz</li>
            <li>• <strong>Biometrics:</strong> Touch ID (home button, paired)</li>
            <li>• <strong>iOS support:</strong> iOS 18 fully supported (no Apple Intelligence)</li>
          </ul>
          <h2 className="text-[24px] md:text-[28px] mb-md">Common problems we see</h2>
          <ul className="space-y-2 text-[15px] mb-lg">
            <li>• <strong>Cracked screen</strong> from drops - chassis is small and slippery</li>
            <li>• <strong>Battery health</strong> dropping after 3 years of heavy use</li>
            <li>• <strong>Lightning port</strong> debris build-up (always try a clean first - free)</li>
            <li>• <strong>Loudspeaker muffled</strong> after gym/pool exposure</li>
            <li>• <strong>Rear camera glass</strong> cracked over the lens (still functional)</li>
          ...
          <p className="text-[15px] leading-relaxed mb-lg">
            <strong>Absolutely.</strong> Fully current, expected to receive iOS 19 and likely iOS 20. 5G, Touch ID for those who want it, and parts are cheap. Repair without hesitation - even logic-board work makes economic sense on this model.
          </p>
        </>
      }
      whatWeFix={[
        ...
        "Lightning port not charging (try free clean first)",
        "Home button click failed",
        "Loudspeaker silent / distorted",
        "Rear camera blurry / cracked lens",
        "5G signal dropping",
        "Front camera and earpiece faults",
      ]}
      steps={[
        { title: "WhatsApp the model + fault",  body: "Photo. We confirm price and pickup window in 4 minutes." },
        { title: "Free pickup or walk in",       body: "Free pickup across Dubai mainland." },
