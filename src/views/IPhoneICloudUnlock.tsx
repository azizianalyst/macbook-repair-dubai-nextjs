    ...
    <IPhonePageTemplate
      ...
      honestyCallout={
        <div className="text-[15px] text-text leading-relaxed space-y-md">
          ...
          <p>
            <strong>Things that don't work (don't pay for them):</strong> iRemoval Pro, iCloud Bypass Tool, checkra1n bypass (only works on iPhone X and older, and re-locks on reboot), DNS bypass (last worked on iOS 9), cheap iCloud Activation Lock removal services advertised on social media (scams or temporary bypasses).
          </p>
          <p>
      ...
      problems={[
        { title: "Forgot Apple ID password - phone is yours", body: "Easiest case. Use iforgot.apple.com on another device. Account recovery via SMS, recovery email, or trusted device. Workshop helps with the process - message us for the exact price, 1-7 days." },
        { title: "Forgot Apple ID email entirely", body: "Apple Account Recovery (3-14 day waiting period). Workshop submits the request and follows up. Message us for the exact price, 2-4 weeks Apple-side." },
        { title: "Inherited iPhone from deceased family member", body: "Apple Estate process. Requires death certificate, court order naming you executor, and the device. Apple unlocks the iCloud account on case-by-case basis. Workshop prepares the submission. Message us on WhatsApp for the exact price." },
        { title: "Bought second-hand, seller forgot to remove iCloud", body: "First step: contact seller, ask them to remove via icloud.com/find. If unreachable: workshop submits Apple liaison request with bill of sale, ID copies, and any communication with seller. Message us for the exact price. Apple decides - no guarantee." },
        ...
        { title: "Bypass services advertised online - scammed already", body: "Common in Dubai. Customer paid a Telegram/Instagram seller for a bypass that either never works, or re-locks on reboot. The workshop will not take additional payment to 'fix' a failed bypass - submit an Apple liaison request properly instead. Message us for the exact documentation-help price." },
        ...
        { title: "Activation Lock on iPad - same process applies", body: "iPad iCloud unlock follows the same Apple liaison process. Pricing depends on documentation complexity - message us on WhatsApp for the exact price." },
        { title: "Want a refurbished iPhone but worried about Activation Lock", body: "Buy from authorised resellers (Apple Refurbished, Carrefour, Sharaf DG) only. Always check Activation Lock status before purchase - Settings > General > Activation Lock, or visit icloud.com/activationlock. Workshop offers free pre-purchase checks." },
      ]}
      steps={[
      ...
      comparisonRows={[
        ...
        ["Forgotten Apple ID",      "Price on request + Apple recovery 3-14 days",   "Not applicable"],
        ["Inherited iPhone",        "Price on request + Apple Estate 2-4 weeks",     "Not applicable - needs documentation"],
        ["Second-hand seller forgot to remove", "Price on request + Apple liaison 1-4 weeks", "Bypass scams don't work"],
      ...
      faqs={[
        ...
        { q: "I forgot my Apple ID password - what do I do?", a: "Easiest case. Visit iforgot.apple.com on another device or computer. Use account recovery via SMS to your trusted phone number, your recovery email, or another trusted Apple device. The workshop helps with the process - message us on WhatsApp for the exact price. Takes 1 to 7 days depending on which recovery method works." },
        { q: "I bought a second-hand iPhone that's still locked to the seller - help?", a: "First, contact the seller and ask them to remove the device remotely from icloud.com/find. This is the easiest path. If the seller is unreachable, the workshop can submit ownership documentation to Apple (bill of sale, ID copies, communication with the seller). Message us on WhatsApp for the exact price. Apple decides - no guarantee. We're upfront about that." },
        ...
        { q: "I inherited my parent's iPhone - can you unlock it?", a: "Yes, through Apple Estate. Required documents: death certificate, court order naming you as executor of the estate, and the device itself. Apple processes inheritance unlocks case-by-case, typically 2 to 4 weeks. Message us on WhatsApp for the exact fee for documentation help and submission." },
        { q: "How much does iCloud unlock cost in Dubai?", a: "The workshop service fee depends on the path - forgotten Apple ID help, inherited devices (Apple Estate), second-hand ownership disputes (Apple liaison), or documentation-prep only. Message us on WhatsApp with your situation for today's exact price. We charge for service time, not for guaranteed unlocks - Apple ultimately decides." },
