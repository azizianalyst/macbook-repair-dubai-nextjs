...
export default function IMacNotTurningOn() {
  return (
    <DevicePageTemplate
      family="imac"
      seoTitle="iMac Not Turning On - Dubai Repair | Free Diagnosis"
      seoDescription="iMac won't turn on? Free diagnosis in Dubai. PSU failures, SMC reset, T2 lockup, fan-only boots, GPU faults. Free pickup across the city. WhatsApp for your price - 055 741 3706."
      path="/imac-not-turning-on-dubai"
      eyebrow="iMac not turning on"
      h1="iMac Not Turning On - Dubai Repair"
      subtitle="From a fan that spins with no chime to a totally dead chassis - we've seen every variant. Free pickup, free diagnosis, honest answer in 24 hours. Message us on WhatsApp for today's exact price on your iMac."
      startingPrice={400}
      timeline="1-3 days"
      ...
      intro={
        <>
          ...
          <p className="text-[16px] text-text-muted leading-relaxed mb-md">
            The single most common cause on 2017-2020 27" iMacs is a failed power supply. Apple's PSU module in those years uses a high-voltage capacitor that dries out after 5-7 years of Dubai heat. Symptom: dead silent, no LED on the back. Replacement takes a day - message us for the exact price on your model. We see it weekly.
          </p>
          <p className="text-[16px] text-text-muted leading-relaxed">
            The second most common is a startup-disk problem: iMac powers on, chimes, then loops on the Apple logo or shows a folder with a question mark. That's not hardware in most cases - APFS corruption, T2 SSD pairing, or a failed firmware update. Often recovered same day - message us for the exact price.
          </p>
        </>
      }
      problems={[
        { title: "Totally dead - no LED, no fan, no chime", body: "Power supply failure (most common on 2017-2020 27\" Intel) or input fuse blown after a surge. We test the input rail in 5 minutes, then message you the exact price for a PSU replacement." },
        { title: "Fan spins, no chime, black screen", body: "GPU initialisation fault on Intel iMacs, or display handoff fault on M-series. Diagnosed in 1 hour. Intel usually needs GPU rework; M-series usually needs board work - message us for the exact price." },
        { title: "Chime, then black screen", body: "Display, backlight or T2 handoff fault - could be backlight rework, T2 service, or a panel swap depending on size. Message us for the exact price once we confirm which." },
        { title: "Apple logo loop", body: "APFS file system corruption, failed macOS update, or T2 SSD pairing fault. Recovery in macOS recovery mode, sometimes a full reformat with data preserved. Message us for the exact price." },
        ...
        { title: "Sleeps and won't wake", body: "SMC fault, sleep-image corruption, or display flex issue. SMC reset + diagnostic, with deeper faults priced after diagnosis - message us for the exact price." },
      ]}
      steps={[
      ...
      comparisonRows={[
        ["Diagnosis fee",         "Free, refundable if no work",      "Paid deposit"],
        ["PSU swap (27\" Intel)", "Price on request - part included", "Often quoted a costly board-swap"],
      ...
      faqs={[
        ...
        { q: `My 27" iMac (2019) was fine yesterday and today won't turn on. What's the most likely cause?`, a: "Power supply, by a mile. Those PSUs fail at 5-7 years and Dubai heat accelerates it. 1 day turnaround and we have the part in stock - message us on WhatsApp for the exact price." },
        ...
        { q: `My iMac chimes but the screen stays black. Is this a screen problem?`, a: "Sometimes - backlight failure on 27\" Retina shows exactly this. But it can also be GPU initialisation. Free diagnosis tells you which, then we message you the exact price for a backlight repair or GPU rework." },
