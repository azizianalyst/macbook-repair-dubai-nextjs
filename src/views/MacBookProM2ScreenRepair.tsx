  ...
  return (
    <MacBookProChipScreenPage
      ...
      chipUniquePoints={[
        ...
        "M2 Pro battery life reaches up to 22 hours in Apple's testing, making this machine worth repairing even at 2-3 years old. A screen repair costs a small fraction of a new M2 Pro, so repair is the clear value choice. The M2 Pro and M2 Max logic boards have no issues related to the display repair.",
