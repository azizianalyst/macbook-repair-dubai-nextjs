...
const FAQS = [
  { q: "Are you an Apple Authorised Service Provider?",
    a: "No. We're an independent Apple repair specialist in Concord Tower, Dubai Media City, working on Apple hardware since 2004. We're not an AASP, so we can't process an Apple warranty or AppleCare claim for you. What we do is repair AppleCare-expired and out-of-warranty Macs at component level, under our own 90-day written warranty." },
  ...
  { q: "Do you use genuine Apple parts?",
    a: "Genuine Apple parts whenever they're available through verified channels. For vintage and obsolete models Apple no longer supplies, we fit high-grade compatible parts and label them as such on your quote. Both are covered by the same 90-day written warranty on our work." },
  { q: "What warranty do you give on the repair?",
    a: "Every repair carries a 90-day written warranty, with six months on batteries. That covers the part we fitted and the workmanship. It's our own warranty, not Apple's - we're independent - but if the same fault comes back inside the window, we sort it at no extra cost." },
  ...
  useSeo(
    {
      ...
      description:
        "In-warranty, AppleCare-eligible and AppleCare-expired MacBook repair guidance in Dubai. Independent Apple specialist, free diagnosis, 90-day warranty. Call 055 741 3706.",
