...
export default function IPhoneDataRecovery() {
  return (
    <IPhonePageTemplate
      seoTitle="iPhone Data Recovery Dubai - Photos, Messages, WhatsApp | Free Diagnosis"
      seoDescription="iPhone data recovery Dubai. iCloud first, chip-off for dead phones. Honest about Secure Enclave limits. iPhone 6 to 17. Message us on WhatsApp 055 741 3706."
      ...
      intro={
        <>
          <p className="text-[17px] text-text leading-relaxed">
            iPhone data recovery in Dubai runs from a quick iCloud-assisted recovery all the way up to forensic chip-off work, so the price depends entirely on your model and what happened - message us on WhatsApp for today's exact quote. The honest truth about iPhone data recovery sets it apart from MacBook or external drive recovery: every iPhone since the iPhone 5s (2013) uses Apple's Secure Enclave processor, which encrypts the entire NAND flash with a hardware-bound key. Without the user's passcode, even physical NAND extraction yields encrypted data that no current commercial tool can decrypt. The workshop is candid about this on every WhatsApp ticket - false promises help no one.
          </p>
      ...
      problems={[
        { title: "Phone won't turn on but storage might be intact", body: "Most common path. Logic-board repair to bring the phone back to bootable state, then customer enters passcode and data is fully accessible. Message us on WhatsApp for the exact price on your model." },
        { title: "Phone boots to Apple logo and reboots (boot loop)", body: "Often a NAND controller fault or BBPMU power-rail issue. Component-level board repair, priced per model - message us for your exact quote. Data preserved when fix succeeds." },
        { title: "Water damage - phone dead, data critical", body: "Bring it in within 24 hours. Ultrasonic clean + corrosion removal + boot. 70% success rate within first day, drops fast after. Message us on WhatsApp for the exact price." },
        { title: "Cracked screen, phone otherwise fine", body: "Not data recovery - just a screen swap (message us for the display price) and the data is fully accessible. Customers often think they need recovery when they only need a display." },
        { title: "Forgot to back up before the iPhone died", body: "If the phone can be brought back to bootable state and the customer knows the passcode, all data is recoverable - message us for the exact price. iCloud backup must be enabled the moment the phone is recovered." },
        ...
        { title: "Chip-off needed (water-damaged phone with critical data)", body: "NAND chip removed under microscope, read on a dedicated programmer. Encrypted data extracted. Decryption requires the passcode. Message us on WhatsApp for the exact price with passcode." },
        ...
        { title: "iTunes / Finder backup needed urgently", body: "If the phone boots and the passcode is known, the workshop can run an encrypted iTunes/Finder backup on the bench - message us for the standalone price. Useful if the screen is broken and the customer can't unlock at home." },
      ...
      steps={[
        ...
        { title: "Easy path first: iCloud + iTunes backup", body: "If iCloud backup exists, it's downloaded to a fresh device - no repair needed. Same-day service - message us on WhatsApp for the exact price. Most data recovery tickets resolve here." },
        { title: "Logic-board repair to make the phone boot", body: "If the phone is dead but the NAND looks intact, micro-solder repair brings the phone back. Customer enters passcode → full data access. Message us for the exact price on your model." },
        { title: "Chip-off NAND recovery (last resort)", body: "If the logic board is destroyed beyond repair, NAND chip removed and read on a programmer. Requires passcode for decryption. Message us on WhatsApp for the exact price with passcode." },
      ...
      warrantyDays={15}
      warrantyBullets={[
        "No-fix-no-charge applies to logic-board repair attempts beyond the standard diagnostic.",
      ...
      comparisonRows={[
        ...
        ["iCloud-assisted",             "Price on request, same day",                    "Free if you do it yourself"],
        ["Logic-board repair",          "Price on request",                              "Not offered, board swap only"],
        ["Chip-off recovery",           "Price on request, with passcode",               "Not offered"],
        ...
        ["Free diagnosis",              "Yes - charged only if work proceeds",           "No, diagnostic fee charged"],
        ["Warranty",                    "30 days on the repair",                         "12 months on service unit (no data)"],
      ]}
      faqs={[
        { q: "Can you recover data from a dead iPhone?", a: "Often yes - most 'data recovery' cases are actually logic-board repairs that bring the phone back to bootable state, after which the customer enters their passcode and data is fully accessible. The price depends on your model - message us on WhatsApp for an exact quote. Genuine NAND-level failures requiring chip-off are rare." },
        { q: "How much does iPhone data recovery cost in Dubai?", a: "It depends on the path your phone needs - iCloud-assisted recovery, logic-board repair to boot, or chip-off NAND recovery with passcode. Forensic chip-off without the passcode has near-zero success on modern iPhones due to Secure Enclave encryption. Message us on WhatsApp with your model and what happened for today's exact price." },
