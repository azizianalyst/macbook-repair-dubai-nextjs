...
export default function MacBookProM1ScreenRepair() {
  return (
    <MacBookProChipScreenPage
      ...
      chipUniquePoints={[
        ...
        "The M1 MacBook Pro (2021) introduced the display notch for the front camera. Replacement assemblies include the camera module integrated into the top of the display housing as a single unit. The notch bezel and camera are not separately replaceable from the panel. We stock M1-specific assemblies for both 14-inch and 16-inch.",
        "Flexgate, the flex cable failure mode seen on 2016-2019 Intel MacBook Pros, does not affect the M1 Pro or M1 Max. The M1 display uses a different cable routing architecture. If your M1 Pro develops a backlight issue it is the panel circuit, not a flex cable fatigue failure.",
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "The 14-inch M1 Pro screen is typically replaced the same day. The 16-inch M1 Max takes 1-2 days as we confirm assembly stock. Free diagnosis is completed within the hour. We contact you before starting any repair.",
        },
        {
          q: "Is the MacBook Pro M1 Pro screen the same as the M1 Max screen?",
          a: "Yes. The M1 Pro and M1 Max use the same Liquid Retina XDR panel in each size. Both the 14-inch M1 Pro and 14-inch M1 Max use the same 3024x1964 panel. Both the 16-inch M1 Pro and 16-inch M1 Max use the same 3456x2234 panel. There is no difference in the display assembly between chip tiers.",
        },
        {
