...
const GUIDES: { label: string; href: string }[] = [
  ...
  { label: "How to take a screenshot on a MacBook", href: "/blog/how-to-take-a-screenshot-on-a-macbook" },
  { label: "How to copy and paste on a MacBook", href: "/blog/how-to-copy-and-paste-on-a-macbook" },
  { label: "How to reset a MacBook", href: "/blog/how-to-reset-a-macbook" },
  { label: "How to recover a MacBook password", href: "/blog/how-to-recover-macbook-password" },
  { label: "How to reset passwords on your MacBook", href: "/blog/how-do-i-reset-passwords-on-my-macbook" },
  { label: "How to change your MacBook's name", href: "/blog/how-to-change-macbook-name" },
  { label: "How to clean a MacBook screen", href: "/blog/how-to-clean-a-macbook-screen" },
  { label: "How to clean a MacBook Pro keyboard", href: "/blog/how-to-clean-macbook-pro-keyboard" },
  { label: "How to erase all data before selling your Mac", href: "/blog/how-to-erase-all-data-on-my-mac-before-giving-it-away" },
  { label: "Record audio while screen recording on Mac", href: "/blog/how-can-i-record-audio-while-screen-recording-on-mac" },
  { label: "How to choose the right MacBook configuration", href: "/blog/how-to-choose-the-right-configuration-for-a-macbook" },
  { label: "Best Apple laptop for gaming", href: "/blog/how-to-choose-the-best-apple-laptop-for-gaming" },
  { label: "Do MacBooks last over a decade?", href: "/blog/do-macbooks-last-over-a-decade" },
