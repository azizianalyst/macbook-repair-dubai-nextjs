...
export default function MacBookMicrophoneRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="MacBook Microphone Repair Dubai - Mic Not Working"
      seoDescription="MacBook microphone repair Dubai. Others can't hear you on calls, muffled mic, no sound input, water-damaged mic array. Usually 1-2 days. WhatsApp 055 741 3706."
      path="/macbook-microphone-repair-dubai"
      eyebrow="MacBook microphone repair"
      h1="MacBook Microphone Repair Dubai"
      subtitle="Nobody can hear you on Teams or FaceTime, your voice sounds muffled, or the input meter sits dead flat. The mic is fixable on every MacBook, usually in 1-2 days."
      startingPrice={350}
      timeline="1-2 days"
      ...
      faqs={[
        { q: "Is my MacBook mic broken, or is it just a setting?", a: "Could be either, and we check the free stuff first. macOS input source, app microphone permissions, and a stuck audio codec cause maybe a third of the 'dead mic' jobs we see. If it's one of those, we sort it and you pay nothing for parts. If the array's actually failed, we quote the repair after the check." },
        { q: "How much does MacBook microphone repair cost in Dubai?", a: "A mic module replacement includes parts and labour, and is VAT-inclusive. If the fault is the audio codec on the logic board rather than the mic, that's a board-level repair quoted after diagnosis. Either way you get the written price on WhatsApp before we start." },
      ...
      related={[
        { label: "MacBook Speaker Repair",     href: "/macbook-speaker-repair-dubai",     description: "No sound out? Driver replacement." },
        { label: "MacBook Water Damage Repair", href: "/macbook-water-damage-repair-dubai", description: "Spills kill the mic array first." },
