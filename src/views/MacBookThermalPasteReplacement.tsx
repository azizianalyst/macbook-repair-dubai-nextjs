...
export default function MacBookThermalPasteReplacement() {
  return (
    <SubServicePageTemplate
      ...
      subtitle="Loud fans, a hot chassis, and a MacBook that throttles the moment you push it. Dried thermal paste is usually the cause. We reapply premium compound and clean the fans, same day."
      startingPrice={280}
      timeline="Same day"
      ...
      intro={
        <>
          ...
          <p className="text-[16px] text-text-muted leading-relaxed">
            We strip the old paste off the chips, clean the heatsink, and reapply a high-grade compound, then clean the fans while the machine is open. That brings temperatures back down and lets the Mac run at full speed again. Diagnosis is free, and you only pay if there's a fix worth doing -, same day.
          </p>
        </>
      }
      whatWeFix={[
      ...
      faqs={[
        ...
        { q: "Do you clean the fans at the same time?", a: "Yes, it's included. The Mac is already open, so we clear dust off both fans and the heatsink fins while we reapply the paste. Dust and dried compound usually go together, and tackling both at once is why temperatures drop properly. same day at our Media City workshop." },
        { q: "Which MacBook models do you do this on, Intel or Apple Silicon?", a: "Both, though Intel MacBooks need it far more often because they run hotter. M1 through M5 Macs run cooler and rarely need a repaste - if yours is Apple Silicon and overheating, it's more likely dust or a fan fault, which the free diagnosis sorts out. We service every model in Dubai." },
        { q: "How long does it take?", a: "Most thermal paste jobs are same day, often within a few hours once it's on the bench. Older MacBook Pros with more disassembly take a little longer. We'll confirm the turnaround after the free diagnosis. Free pickup across Dubai mainland, fix." },
        { q: "Is replacing the thermal paste safe for my MacBook?", a: "It is when done properly. The risk is using too much paste or damaging the heatsink mounting, which is why a careful job matters. Abdul Aziz has 21 years on Apple boards and we torque the heatsink back to spec. Your data stays untouched. 12-month warranty in Dubai." },
        { q: "Why does my MacBook overheat more in Dubai?", a: "Ambient heat is the difference. A Mac that idles fine in a cold climate has far less thermal headroom in a Dubai summer, so dried paste shows up as fans roaring and throttling much faster here. Reapplying fresh compound buys back that margin. Free check, fix at Concord Tower, Media City." },
      ]}
      ...
      related={[
        ...
        { label: "MacBook Battery Replacement",   href: "/macbook-battery-replacement-dubai",     description: "Heat shortens battery life. Genuine-capacity cells." },
      ]}
      quickAnswer={{
        question: "How much does MacBook thermal paste replacement cost in Dubai?",
        answer: "MacBook thermal paste replacement is carried out at MacBook Repair Dubai in Concord Tower, Media City. It includes stripping the dried compound, reapplying premium paste, and cleaning both fans, with a free diagnosis and 12-month warranty. Most jobs are done the same day.",
      }}
    />
  );
}
