...
export default function IPadCameraRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPad Camera Repair Dubai | Center Stage Calibration"
      seoDescription="iPad rear and front camera repair Dubai. TrueDepth on Pro, landscape camera on Air M3+. Center Stage recalibrated. 1-2 days. Message us on WhatsApp for a price."
      path="/ipad-camera-repair-dubai"
      eyebrow="iPad camera repair"
      h1="iPad Camera Repair Dubai"
      subtitle="Cracked rear lens, blurry FaceTime, dead Center Stage tracking, or a misaligned landscape camera on iPad Air M3+. We replace the module and recalibrate. Ready in 1-2 days - message us on WhatsApp for a price."
      startingPrice={400}
      timeline="1-2 days"
      ...
      steps={[
        ...
        { title: "Lens vs module decision",    body: "Microscope inspection: if only the outer glass is cracked we replace the lens. If the sensor itself failed, we do a full module. We message you the exact price for either before starting." },
        ...
        { title: "Center Stage recalibration", body: "Run iPadOS camera calibration sequence so Center Stage tracks correctly. Warranty up to 12 months card with the iPad." },
      ]}
      warrantyDays={365}
      warrantyBullets={[
      ...
      faqs={[
        ...
        { q: "Can you fix lens scratches without replacing?", a: "No - lens scratches diffuse light and ruin photos permanently. Replacing the outer lens is the only honest fix - message us on WhatsApp for the exact price on your iPad." },
      ]}
      reviewNames={["Anatoliy Tarasenko", "Anastasiia Goncia", "Ana Undricova"]}
      related={[
        { label: "iPad Screen Repair Dubai",     href: "/ipad-screen-repair-dubai",     description: "Pencil-safe screen swaps - message us for a price." },
