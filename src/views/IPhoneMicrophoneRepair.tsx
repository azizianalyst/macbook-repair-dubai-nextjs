...
export default function IPhoneMicrophoneRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone Microphone Repair Dubai | 1-Day Turnaround"
      seoDescription="iPhone microphone repair Dubai. Modern iPhones have 4 mics - we isolate which is broken. Often water-damage related. 1 day. Message us for a price. Call 055 741 3706."
      path="/iphone-microphone-repair-dubai"
      eyebrow="iPhone microphone repair"
      h1="iPhone Microphone Repair Dubai"
      subtitle={`"They can't hear me on calls" - but every modern iPhone has four microphones. We isolate which one has died before quoting you. Most repairs done in 1 day, warranty of up to 12 months. Message us on WhatsApp for today's exact price on your model.`}
      startingPrice={300}
      timeline="1 day"
      ...
      intro={
        <>
          ...
          <p className="text-[16px] text-text-muted leading-relaxed">
            We run a four-mic test in iOS to isolate the dead one before quoting. The bottom mic dies most often (water and lint). Back-camera mic comes second (drops). One flat price covers any single microphone replacement, same workshop visit - message us on WhatsApp for today's exact figure on your model.
          </p>
        </>
      }
      whatWeFix={[
