...
export default function IPhone17Repair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone 17 Repair Dubai - A19, 120Hz ProMotion, Same Day | 055 741 3706"
      seoDescription="iPhone 17 (Sept 2025) repair Dubai. A19, 6.3-inch ProMotion (first non-Pro), Always-On, Ceramic Shield 2, Wi-Fi 7. Same-day. WhatsApp for a price."
      ...
      subtitle="The current 6.3-inch flagship - A19, 120Hz ProMotion (first non-Pro), AOD, Ceramic Shield 2, N1 chip with Wi-Fi 7. Message us on WhatsApp for today's price."
      startingPrice={400}
      timeline="Same day"
      ...
      serviceName="iPhone 17 Repair Dubai"
      intro={
        <>
          ...
          <div className="overflow-x-auto border border-border rounded-md bg-bg-card mb-lg">
            <table className="w-full text-[14px] min-w-[560px]">
              ...
              <tbody>
                <tr><td className="px-md py-sm">ProMotion OLED + Ceramic Shield 2 replacement</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">Same day</td><td className="px-md py-sm"><Link to="/iphone-screen-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
                ...
                <tr className="bg-bg-alt"><td className="px-md py-sm">Camera Control button repair</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">2-3 days (parts)</td><td className="px-md py-sm"><Link to="/iphone-power-button-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
          ...
          <p className="text-[15px] leading-relaxed mb-lg">
            <strong>Absolutely - it is the current iPhone.</strong> Resale value is still very strong and iOS 25 is expected, so a single repair is almost always well worthwhile. Message us on WhatsApp for the exact repair price on your model.
          </p>
        </>
      }
      whatWeFix={[
      ...
      faqs={[
        ...
        { q: "Bundle pricing?", a: "Yes - we bundle common pairings like screen + battery, or Camera Control + Action Button, at a saving versus booking each separately. Message us on WhatsApp for the exact bundle price on your iPhone 17." },
        { q: "Genuine Apple OLED?", a: "Yes - we offer both genuine Apple-pull and OEM-grade OLED options. We are factory-trained on the new ProMotion + AOD calibration. Message us on WhatsApp for the price on each option." },
      ...
      related={[
        { label: "iPhone Screen Repair Dubai",      href: "/iphone-screen-repair-dubai",      description: "ProMotion + Ceramic Shield 2 - price on request." },
        { label: "iPhone Battery Replacement",      href: "/iphone-battery-replacement-dubai",description: "45 minutes - price on request." },
        { label: "iPhone USB-C Port Repair Dubai",  href: "/iphone-usb-c-port-repair-dubai",  description: "USB-C 2.0 - price on request." },
      ]}
    />
  );
}
