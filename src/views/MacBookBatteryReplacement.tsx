        ...
        <section className="mx-auto max-w-content px-5 md:px-6 py-4xl">
          ...
          <div className="grid gap-lg md:grid-cols-3">
            <Card className="border-accent/30 bg-accent/[0.06]">
              <h3 className="m-0 mb-2 text-text text-[18px] font-bold">Same day (2 hours bench)</h3>
              <p className="m-0 text-[14px] text-text-muted leading-relaxed">All MacBook Air 11″/13″/15″, all MacBook Pro 13″/14″/15″/16″ - Intel and Apple Silicon. 92 of last 100 battery tickets delivered before 7 pm same day.</p>
            </Card>
            <Card>
              <h3 className="m-0 mb-2 text-text text-[18px] font-bold">Same day (3 hours)</h3>
              <p className="m-0 text-[14px] text-text-muted leading-relaxed">MacBook 12″ Retina 2015-2017 - the 6-cell custom-shape pack takes longer to seat correctly. Still same-day, just 60 extra minutes.</p>
            </Card>
            <Card>
              <h3 className="m-0 mb-2 text-text text-[18px] font-bold">2 days (very rare)</h3>
              <p className="m-0 text-[14px] text-text-muted leading-relaxed">Only when the battery + trackpad both need replacing because the swelling cracked the trackpad. The trackpad ships from local stock within 24 hours.</p>
            </Card>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-content px-5 md:px-6 py-4xl">
            ...
            <div className="grid gap-lg md:grid-cols-2">
              ...
              <Card>
                ...
                <p className="m-0 mb-sm text-[14px] text-text-muted leading-relaxed">B-grade cells, often re-wrapped used cells, no batch traceability, no IATA certification. Failure rate: 40% within 6 months, 15% swelling within 12 months. The workshop will not fit these even if the customer brings them.</p>
            ...
            <div className="grid gap-lg md:grid-cols-2">
              <Card className="border-accent/30 bg-accent/[0.06]">
                ...
                <ul className="space-y-2.5 text-[14px] text-text-muted list-none p-0 m-0">
                  <li className="flex items-start gap-2"><Check size={15} className="text-accent mt-1 shrink-0" aria-hidden /> SMC reset - fixes ~10% of "battery not charging" cases on Intel Macs at zero cost.</li>
                  <li className="flex items-start gap-2"><Check size={15} className="text-accent mt-1 shrink-0" aria-hidden /> Recalibrate by running the battery flat then charging to 100% - corrects firmware capacity readings.</li>
                  <li className="flex items-start gap-2"><Check size={15} className="text-accent mt-1 shrink-0" aria-hidden /> Check Energy Saver settings - high brightness + connected USB-C accessories can halve runtime without a battery fault.</li>
                  <li className="flex items-start gap-2"><Check size={15} className="text-accent mt-1 shrink-0" aria-hidden /> Run System Information &gt; Power to view raw cycle count and design capacity for an objective baseline.</li>
                </ul>
              </Card>
              <Card>
                <h3 className="m-0 mb-md text-text text-[18px] font-bold">Stop and bring it in</h3>
                <ul className="space-y-2.5 text-[14px] text-text-muted list-none p-0 m-0">
                  <li className="flex items-start gap-2"><AlertTriangle size={15} className="text-accent mt-1 shrink-0" aria-hidden /> Any visible swelling - fire risk, do not charge or operate.</li>
                  <li className="flex items-start gap-2"><AlertTriangle size={15} className="text-accent mt-1 shrink-0" aria-hidden /> Battery hot to touch in idle - internal short, replace before swelling.</li>
                  <li className="flex items-start gap-2"><AlertTriangle size={15} className="text-accent mt-1 shrink-0" aria-hidden /> Sudden shutdowns at 30%+ remaining - battery cell failure or PMIC issue, both diagnosed free.</li>
                  <li className="flex items-start gap-2"><AlertTriangle size={15} className="text-accent mt-1 shrink-0" aria-hidden /> 2013+ MacBook - adhesive removal needs a heat gun and isopropyl 99%; DIY mistakes ruin the trackpad cable below.</li>
                </ul>
              </Card>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-content px-5 md:px-6 py-4xl">
            <div className="mb-2xl flex items-end justify-between gap-md flex-wrap">
              <div>
                ...
                <h2 className="m-0 text-text">Real battery-repair reviews</h2>
              </div>
