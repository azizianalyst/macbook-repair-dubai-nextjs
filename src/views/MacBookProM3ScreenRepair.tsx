...
export default function MacBookProM3ScreenRepair() {
  return (
    <MacBookProChipScreenPage
      ...
      prices={[
        { model: "MacBook Pro 14-inch M3 Pro (late 2023)", price: 1000, applePrice: 1499, timeline: "Same day", l4href: "/macbook-pro-14-m3-2023-repair-dubai" },
        { model: "MacBook Pro 16-inch M3 Max (late 2023)", price: 1200, applePrice: 1699, timeline: "1-2 days", l4href: "/macbook-pro-16-m3-2023-repair-dubai" },
      ]}
      faults={[
        {
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "The 14-inch M3 Pro is typically repaired the same day. The 16-inch M3 Max takes 1-2 days. Free diagnosis is completed within the hour of arrival.",
        },
        {
          q: "Does the Space Black colour change the repair cost for M3 MacBook Pro?",
          a: "The display assembly itself is the same for Space Black and Silver M3 MacBook Pros in terms of the panel and backlight. The bezel frame surrounding the screen uses the Space Black anodised finish on Space Black models. We use M3-specific assemblies that match the original bezel colour of your machine.",
        },
        {
