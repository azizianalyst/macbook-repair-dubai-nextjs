...
export default function IPhone13MiniRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone 13 Mini Repair Dubai - 5.4-inch OLED Screen & Battery | 055 741 3706"
      seoDescription="iPhone 13 Mini (2021) repair Dubai. A15, 5.4-inch OLED, last Mini ever. Screen, battery & Face ID. Same-day, warranty of up to 12 months. WhatsApp for pricing."
      path="/iphone-13-mini-repair-dubai"
      eyebrow="iPhone 13 Mini (2021)"
      h1="iPhone 13 Mini Repair Dubai - Screen, Battery, Face ID"
      subtitle="The last 5.4-inch iPhone - A15, improved battery vs 12 Mini, diagonal cameras. iOS 18 supported. Message us on WhatsApp for today's price."
      startingPrice={300}
      timeline="Same day"
      ...
      intro={
        <>
          ...
          <div className="overflow-x-auto border border-border rounded-md bg-bg-card mb-lg">
            <table className="w-full text-[14px] min-w-[560px]">
              ...
              <tbody>
                ...
                <tr><td className="px-md py-sm">Dual camera replacement</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">Same day</td><td className="px-md py-sm"><Link to="/iphone-camera-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
          ...
          <p className="text-[15px] leading-relaxed mb-lg">
            <strong>Absolutely.</strong> A15, iOS 18 supported (iOS 19 expected), and a small-phone fan-favourite - used resale stays strong because Apple discontinued the Mini line. A battery-plus-screen refresh costs a fraction of the 13 Mini's used market value, so it's a clear win. Message us on WhatsApp for the exact repair price.
          </p>
        </>
      }
      whatWeFix={[
      ...
      faqs={[
        { q: "Why is battery the most-common 13 Mini repair?", a: "The Mini has the smallest cell of any modern iPhone (2,406 mAh). After 4 years of daily charges, capacity often drops below 80%. A replacement takes about 45 minutes - message us on WhatsApp for today's exact price." },
        { q: "Do you offer bundle pricing?", a: "Yes - combining a screen with a battery, or a battery with back glass, works out cheaper than booking them separately. Message us on WhatsApp for your bundle price." },
        { q: "Genuine Apple OLED?", a: "Yes - we stock both genuine Apple-pull OLED and OEM-grade hard-OLED. Message us on WhatsApp to compare the two for your 13 Mini." },
      ...
      related={[
        { label: "iPhone Screen Repair Dubai",       href: "/iphone-screen-repair-dubai",       description: "5.4-inch hard-OLED, same-day." },
        { label: "iPhone Battery Replacement",       href: "/iphone-battery-replacement-dubai", description: "45-minute swap, warranty included." },
