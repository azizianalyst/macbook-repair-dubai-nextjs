...
export default function MacBookAirM3BatteryReplacement() {
  return (
    <MacBookAirChipBatteryPage
      ...
      faults={[
        ...
        },
        {
          ...
          body: "The fanless M3 Air thermal-throttles under sustained load, which can make it feel battery-hungry. This is normal and not a battery fault. Monitor with Activity Monitor under Energy tab. If maximum capacity is below 90% at under 300 cycles, this may be early degradation — free health check.",
        },
        {
        ...
        },
        {
          ...
          body: "Deeply discharging a lithium-ion cell (to 0V) can latch the BMS protection circuit. Connecting MagSafe for 30 minutes before the system boots often recovers it. If it does not power on after 30 minutes on charge, bring it in — we can trickle-charge the cell to revive it or confirm replacement is needed.",
        },
        {
        ...
        },
        {
          ...
          body: "Warm MagSafe brick without charging usually indicates a damaged MagSafe 3 board inside the Air, not a battery fault. Try charging via USB-C to isolate. If USB-C charges but MagSafe doesn't, the MagSafe board is the issue. We diagnose free and quote separately.",
        },
      ]}
      faqs={[
        {
        ...
        },
        {
          ...
          a: "Dubai's ambient temperatures (40°C+ summers) age lithium-ion cells faster than Apple's lab conditions assume. If your M3 Air was left in a hot car regularly or charged in direct sunlight, the cell may show 85–90% capacity at under 200 cycles. Below 80% = service recommended. We offer a free health check to confirm before recommending replacement.",
        },
        {
          q: "Does the MacBook Air M3 need BMS re-pair after battery replacement?",
          a: "Yes. All Apple Silicon Macs (M1 and newer) require BMS firmware re-pair after battery replacement so macOS correctly reports capacity, cycle count, and charging health. BMS re-pair is included in our price — no hidden extras.",
        },
        {
          q: "How long does MacBook Air M3 battery replacement take?",
          a: "Same-day 2-hour service at our Dubai Media City workshop. We carry 52.6 Wh (13-inch) and 66.5 Wh (15-inch) M3 Air cells in stock. Drop off before 11am, collect same afternoon.",
        },
        {
          q: "Is the M3 Air battery life as good as Apple claims?",
          a: "Under light use (web browsing, documents, video streaming) at medium brightness, yes — 16–18 hours on the 13-inch is achievable. Under heavier load (Lightroom, coding, dual external displays), expect 8–12 hours. If your M3 Air is delivering only 5–7 hours under light use, the battery health is likely below 80% and replacement will restore rated life.",
        },
      ]}
