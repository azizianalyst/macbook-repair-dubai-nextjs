  ...
  return (
    <SubServicePageTemplate
      ...
      faqs={[
        ...
        { q: "Can I upgrade the RAM on the 2018 Intel Mac mini?", a: "Yes. The 2018 Intel Mac mini is the one model with a real internal upgrade: two SO-DIMM slots that take up to 64GB. M1, M2 and M4 minis have RAM soldered onto the chip package and cannot be upgraded. RAM upgrade on the 2018 is a flat quoted job plus the modules at market price." },
