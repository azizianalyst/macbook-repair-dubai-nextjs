...
export default function IPhoneWifiBluetoothRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone WiFi & Bluetooth Repair Dubai | 2-Day Fix"
      seoDescription="iPhone WiFi grayed-out, Bluetooth not connecting. Combined wireless chip board work. 2 days, warranty of up to 12 months. WhatsApp us for a price. Call 055 741 3706."
      path="/iphone-wifi-bluetooth-repair-dubai"
      eyebrow="iPhone wireless repair"
      h1="iPhone WiFi & Bluetooth Repair Dubai"
      subtitle="WiFi greyed out in Settings, Bluetooth pairing fails, or wireless drops every few minutes. The wireless chip needs board-level work. Message us on WhatsApp for today's price — 2 days."
      startingPrice={400}
      timeline="2 days"
      ...
      faqs={[
        ...
        { q: "Could it be antenna instead of chip?", a: "Yes, occasionally. Antennas live near the side bezel and corrode after pool exposure. Antenna replacement is cheaper and we'll quote that on WhatsApp if it's the actual fault." },
