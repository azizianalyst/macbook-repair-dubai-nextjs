...
export default function IPhoneSimTrayRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone SIM Tray Repair Dubai - Physical & eSIM | Same Day"
      seoDescription="iPhone SIM tray repair Dubai. Lost tray or broken reader fixed same day. Dual-SIM and eSIM advice for UAE. WhatsApp for a price. Call 055 741 3706."
      path="/iphone-sim-tray-repair-dubai"
      eyebrow="iPhone SIM tray repair"
      h1="iPhone SIM Tray Repair Dubai - SIM & eSIM"
      subtitle="Lost the tray, bent it on the way out, or the SIM reader inside has died. A tray swap or a full reader replacement - message us on WhatsApp for today's exact price. Same day on most models."
      startingPrice={150}
      timeline="Same day"
      ...
      intro={
        <>
          <p className="text-[18px] leading-relaxed mb-md">
            <strong>Two different problems</strong>, one page: a lost or bent SIM tray (a quick, low-cost swap) versus a dead SIM reader inside the phone (a proper board-level repair). We'll tell you which you have within 5 minutes of looking at the phone, free, and message you the exact price on WhatsApp. The reader fault is more common after a careless tray insertion that bent a pin.
          </p>
      ...
      whatWeFix={[
        "Lost SIM tray - quick low-cost replacement",
      ...
      steps={[
        ...
        { title: "Tray-only fix",               body: "Walk-in, 5 minutes, includes a free SIM eject tool. Message us on WhatsApp for the exact price." },
        { title: "Reader replacement",          body: "We open the phone from the bottom, swap the SIM reader flex, and reseat dual-SIM rails on UAE-spec models. WhatsApp us for the exact price on your model." },
      ...
      faqs={[
        { q: "I bought my iPhone in the US - can I add a UAE SIM?", a: "Only via eSIM. US iPhone 14+ have no physical tray. Both Etisalat and du support iPhone eSIM. We'll set it up free if you're already in for a different repair, or message us on WhatsApp for the price of an eSIM-only assistance walk-in." },
