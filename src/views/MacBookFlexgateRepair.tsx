  ...
  return (
    <SubServicePageTemplate
      ...
      warrantyBullets={[
        ...
        "Free re-fit if the backlight fault returns inside 90 days.",
      ]}
      faqs={[
