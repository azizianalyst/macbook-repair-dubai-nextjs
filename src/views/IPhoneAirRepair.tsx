...
export default function IPhoneAirRepair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone Air Repair Dubai - Thinnest iPhone Ever | 055 741 3706"
      seoDescription="iPhone Air (Sept 2025) repair Dubai. A19, 6.5-inch OLED, single camera, thinnest iPhone ever. Screen, battery and more - same-day. Message us for a quote."
      ...
      subtitle="The thinnest iPhone Apple has ever made - A19, 6.5-inch OLED, single camera. Replaced the Plus in the lineup. Message us on WhatsApp for today's price."
      startingPrice={400}
      timeline="Same day"
        ...
        <>
          ...
          <div className="overflow-x-auto border border-border rounded-md bg-bg-card mb-lg">
            <table className="w-full text-[14px] min-w-[560px]">
              ...
              <tbody>
                <tr><td className="px-md py-sm">ProMotion OLED + Ceramic Shield 2</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">Same day</td><td className="px-md py-sm"><Link to="/iphone-screen-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
                ...
                <tr><td className="px-md py-sm">Back glass + MagSafe coil</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">2 days</td><td className="px-md py-sm"><Link to="/iphone-back-glass-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
                <tr className="bg-bg-alt"><td className="px-md py-sm">Single 48 MP camera replacement</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">Same day</td><td className="px-md py-sm"><Link to="/iphone-camera-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
                ...
                <tr className="bg-bg-alt"><td className="px-md py-sm">Camera Control button</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">2-3 days (parts)</td><td className="px-md py-sm"><Link to="/iphone-power-button-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
                <tr><td className="px-md py-sm">Titanium frame straighten / polish</td><td className="px-md py-sm">Price on request</td><td className="px-md py-sm">2-3 days</td><td className="px-md py-sm"><Link to="/iphone-back-glass-repair-dubai" className="text-accent font-semibold hover:underline">Book →</Link></td></tr>
          ...
          <p className="text-[15px] leading-relaxed mb-lg">
            <strong>Strong yes - Apple still sells it new.</strong> Used resale value stays strong and iOS 25 is expected, so nearly any single repair is well worthwhile. Message us on WhatsApp for today's exact price on your model.
          </p>
        </>
      }
      whatWeFix={[
      ...
      faqs={[
        ...
        { q: "Bundle pricing?", a: "Yes - we discount when you combine repairs, like screen + battery or screen + back glass. Message us on WhatsApp with your device and we'll confirm the bundled price." },
        { q: "Will my Air bend in my pocket?", a: "Apple's titanium frame is stiff for its thickness, but sustained pressure (sat-on, kneeled-on, jeans pocket pressure) can deform the frame. We straighten light bends - message us for the exact price." },
        { q: "Genuine Apple OLED?", a: "Yes - we offer both genuine Apple and OEM-grade OLED. The Air OLED is bonded directly to a thinner mid-frame; we use the correct laminating press. Message us on WhatsApp for the price of each option." },
        { q: "Same day?", a: "OLED, battery, USB-C, single camera - yes. Back glass + frame work 2-3 days." },
      ]}
      reviewNames={["Seyed Moulana", "B Parker"]}
      related={[
        { label: "iPhone Screen Repair Dubai",      href: "/iphone-screen-repair-dubai",      description: "ProMotion + Ceramic Shield 2 - message us for a price." },
        { label: "iPhone Back Glass Repair Dubai",  href: "/iphone-back-glass-repair-dubai",  description: "Air bespoke back glass + MagSafe - message us for a price." },
        { label: "iPhone Battery Replacement",      href: "/iphone-battery-replacement-dubai",description: "45 minutes - message us for a price." },
      ]}
    />
  );
}
