...
export default function IPhoneChargingPortRepair() {
  return (
    <IPhonePageTemplate
      seoTitle="iPhone Charging Port Repair Dubai - Lightning & USB-C | Same Day"
      seoDescription="iPhone charging port repair Dubai - Lightning & USB-C, bent pins, water damage, intermittent charge. iPhone 6 to 17. Same-day. WhatsApp 055 741 3706 for a quote."
      ...
      pricingCaption="Pro Max sizes are priced a little higher - message us for your model. Charging IC repair (logic board) is quoted separately if a port swap doesn't restore charging."
      intro={
        <>
          <p className="text-[17px] text-text leading-relaxed">
            iPhone charging port repair in Dubai is priced per model and finishes the same day on most Lightning models - message us on WhatsApp for today's exact price on your iPhone. The split between Lightning and USB-C matters: every iPhone before the iPhone 15 (so iPhone 6 through iPhone 14 Pro Max) uses the Apple Lightning connector - a small, simple flex cable that's straightforward to swap. From the iPhone 15 forward, Apple moved to USB-C - a different mechanical assembly with a separate FPC, four extra solder points, and tighter bond tolerance. The workshop has been fitting Lightning ports since 2014 and USB-C ports since the iPhone 15 launched in September 2023.
          </p>
      ...
      problems={[
        { title: "Cable falls out unless held at an angle", body: "Worn pins inside the port - most common after 18+ months of daily charging. Port-flex swap restores secure fit. Message us for the exact price on your model." },
        { title: "Phone says 'Liquid Detected in Lightning Connector'", body: "Sensor inside the port detects moisture and disables fast charging. Sometimes the sensor fails after a previous spill - replacement port flex restores normal charging without the warning. Message us for your model's price." },
        { title: "Bent pins inside the port", body: "Visible damage from forcing a USB-C plug into a Lightning port (or vice versa). Port flex must be replaced - the pins are not individually serviceable. Same day; message us for the price on your model." },
        { title: "Charges only on certain cables", body: "Some pins still functional - phone negotiates 5W charging with the working pins. Full port swap restores 20W fast charge. Message us for the exact price on your model." },
        { title: "iPhone 15/16/17 USB-C wobbles in port", body: "USB-C connectors are physically larger and the FPC bond is tighter. A drop on a connected cable can shear the bond. Port flex replacement - message us for your model's price." },
        ...
        { title: "Charging IC failure on the logic board", body: "Port flex tested OK but phone still won't charge. The Tristar (Lightning) or VL161 (USB-C) IC on the logic board is failing. Component-level repair, 1 day. Free diagnosis to confirm; message us for the price." },
      ...
      comparisonRows={[
        ...
        ["iPhone 11 port",               "Price on request",                     "Whole-unit swap only"],
        ["iPhone 14 Pro port",           "Price on request",                     "Whole-unit swap only"],
        ["iPhone 16 Pro USB-C port",     "Price on request",                     "Whole-unit swap only"],
        ["Component-level board repair", "Yes - if needed",                      "No, board swap only"],
      ...
      faqs={[
        { q: "How much does iPhone charging port repair cost in Dubai?", a: "It's priced per model - iPhone 6 through 8 and SE are the most affordable, X through 14 Pro sit in the middle, and iPhone 15, 16, 17 (USB-C) are a little more. Pro Max sizes are priced slightly higher. If the port flex tests fine but the phone still won't charge, the issue is the charging IC on the logic board - a 1-day component-level repair. Message us on WhatsApp with your model for today's exact price." },
        ...
        { q: "What about the 'Liquid Detected' warning?", a: "iOS 14+ shows this warning when the port sensor detects moisture. Drying the port for 24 hours clears it 60% of the time. If the warning persists with a dry port, the sensor itself has failed - port flex replacement removes it. Message us for the exact price on your model." },
        ...
        { q: "What if my phone still doesn't charge after the port is replaced?", a: "Then the issue is the charging IC on the logic board - Tristar U2 (Lightning) or VL161 (USB-C). Component-level micro-soldering, 1 day. The port flex price is credited toward this repair, so you only pay for the IC repair, not both. Message us for the exact price." },
        { q: "Do you fix charging issues on iPad with USB-C?", a: "Yes - iPad Pro, Air, and mini USB-C port repair too. Same workshop, same Shafiq, same warranty. WhatsApp the iPad model for a quote." },
      ]}
