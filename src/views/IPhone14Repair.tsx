...
export default function IPhone14Repair() {
  return (
    <SubServicePageTemplate
      seoTitle="iPhone 14 Repair Dubai - 6.1-inch OLED Screen & Battery | 055 741 3706"
      seoDescription="iPhone 14 (2022) repair Dubai. A15, 6.1-inch OLED, Crash Detection. Screen, battery, Face ID. Same-day, warranty of up to 12 months. WhatsApp for a quote."
      path="/iphone-14-repair-dubai"
      eyebrow="iPhone 14 (2022)"
      h1="iPhone 14 Repair Dubai - Screen, Battery, Camera, Face ID"
      subtitle="The 6.1-inch iPhone 14 - A15 (reused from 13 Pro), Crash Detection, dual SIM in UAE, MagSafe. iOS 18 supported. Message us for today's price."
      startingPrice={300}
      timeline="Same day"
      ...
      intro={
        <>
          <p className="text-[18px] leading-relaxed mb-md">
            <strong>Quick answer:</strong> The iPhone 14 (Sept 2022) - A15 Bionic (same as 13 Pro), 6.1-inch Super Retina XDR OLED, dual camera, Crash Detection, Emergency SOS via satellite (US-only), dual physical SIM in UAE, MagSafe, IP68. Apple replaced the Mini with the Plus for this generation. We repair screen, battery, camera and Face ID - message us on WhatsApp for today's exact price on your iPhone 14.
          </p>
          ...
          <p className="text-[15px] leading-relaxed mb-lg">
            <strong>Strong yes.</strong> Only ~3 years old, A15, iOS 19 + 20 expected, and it still holds strong resale value. A single repair is almost always worthwhile - message us for the exact price on your model.
          </p>
        </>
      }
      whatWeFix={[
      ...
      faqs={[
        { q: "Why is iPhone 14 back-glass repair easier?", a: "Apple redesigned the internals so the back glass is removable from the rear (instead of pulling the screen first). Repairs are faster and cheaper than on older models. Message us for the exact price." },
        { q: "Do you offer bundle pricing?", a: "Yes - combining repairs like screen + battery or battery + back glass saves you money versus booking them separately. WhatsApp us your model for the bundle price." },
      ...
      related={[
        ...
        { label: "iPhone Battery Replacement",       href: "/iphone-battery-replacement-dubai", description: "Done in 45 minutes." },
        { label: "iPhone Back Glass Repair Dubai",   href: "/iphone-back-glass-repair-dubai",   description: "Easier on 14 series." },
      ]}
    />
  );
}
