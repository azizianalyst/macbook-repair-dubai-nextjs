  ...
  return (
    <BlogPostTemplate
      ...
      toc={[
        ...
        { id: "salt-vs-fresh-water", label: "Salt vs fresh water" },
        { id: "pricing-tiers", label: "Pricing tiers" },
        { id: "ultrasonic-clean-process", label: "Ultrasonic clean process" },
        { id: "not-recoverable", label: "When it's not recoverable" },
        { id: "insurance-claims", label: "Insurance claims" },
        { id: "apple-store-policy", label: "Apple Store policy" },
      ...
      readingMinutes={10}
      featuredImageAlt="iPhone Water Damage Repair Cost Dubai, iPhone water damage repair Dubai - ultrasonic cleaning bath in workshop"
      body={
        <>
          <h2 id="first-24-hours">iPhone Water Damage Repair Cost Dubai. First 24 hours - what to do (and not do)</h2>
          <p>
          ...
          <h2 id="salt-vs-fresh-water">Salt water vs fresh water - Dubai beach vs pool</h2>
          <p>
          ...
          <h2 id="ultrasonic-clean-process">What we actually do - the ultrasonic clean process</h2>
          <p>
          ...
          <h2 id="not-recoverable">When water damage isn't recoverable - be honest</h2>
          <p>
