...
export default function MacBookTouchIDRepair() {
  return (
    <SubServicePageTemplate
      ...
      subtitle="Fingerprint won't enrol, sensor ignores your touch, or the power button's gone dead. We diagnose and repair the Touch ID and power button - and we're honest about what board pairing does and doesn't allow. Written quote first."
      startingPrice={350}
      timeline="1-2 days"
      ...
      faqs={[
        ...
        { q: "How much does Touch ID and power button repair cost in Dubai?", a: "When the fix is the sensor flex or a reseat it is one flat quoted job, parts and labour included and VAT-inclusive. Board-level power-circuit repairs are quoted after diagnosis. You get the written price on WhatsApp first, and the diagnosis is free even if you decide not to go ahead." },
