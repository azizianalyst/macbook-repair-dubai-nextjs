...
export default function BlogIPadScreenRepairCost() {
  return (
    <BlogPostTemplate
      ...
      seoDescription="iPad screen repair prices Dubai 2026: AED 450 (iPad 9) to AED 1,200 (iPad Pro M5). Mini-LED vs Liquid Retina, Apple Store comparison, same-day service."
      path="/blog/ipad-screen-repair-cost-dubai-2026"
      category="Cost guide · iPad"
      h1="iPad Screen Repair Cost in Dubai 2026 - Every Model"
      hook="iPad screen repair in Dubai ranges from AED 450 on the entry-level iPad 9 to AED 1,200 on the iPad Pro M5 — here is the full model-by-model price list."
      quickAnswer="iPad screen repair in Dubai costs AED 450–1,200 in 2026. Entry iPads are AED 450–600. iPad Air models are AED 650–850. iPad Pro with Liquid Retina XDR (mini-LED or OLED) is AED 900–1,200. Most repairs are same-day with a 3-month written warranty."
      author={{ name: "Ali", role: "Senior iPad screen technician" }}
      datePublished="2026-06-09"
      dateModified="2026-06-09"
      readingMinutes={11}
      featuredImageAlt="iPad screen repair Dubai - technician replacing Liquid Retina display on workbench"
      faqs={[
      ...
      body={
        <>
          <h2>The full iPad screen repair price list — 2026, Dubai</h2>
          <p>
          ...
          <BlogPriceTable
            ...
            rows={[
              { model: "iPad 9th gen (2021)",                ours: "AED 450",   apple: "AED 749",   note: "Liquid Retina LCD, plentiful parts" },
              { model: "iPad 10th gen (2022)",               ours: "AED 550",   apple: "AED 849",   note: "Liquid Retina LCD, USB-C chassis" },
              { model: "iPad 11th gen (2025)",               ours: "AED 600",   apple: "AED 899",   note: "Liquid Retina LCD, A16" },
              { model: "iPad mini 5 (2019)",                 ours: "AED 480",   apple: "AED 749",   note: "Liquid Retina LCD" },
              { model: "iPad mini 6 (2021)",                 ours: "AED 550",   apple: "AED 849",   note: "Touch ID in button, no home button" },
              { model: "iPad mini 7 (2024)",                 ours: "AED 580",   apple: "AED 899",   note: "A17 Pro chip, same form factor" },
              { model: "iPad Air 4 (2020)",                  ours: "AED 650",   apple: "AED 999",   note: "Liquid Retina LCD, Touch ID in button" },
              { model: "iPad Air 5 (2022)",                  ours: "AED 650",   apple: "AED 999",   note: "M1 chip, same LCD panel" },
              { model: "iPad Air M2 11″ (2024)",             ours: "AED 700",   apple: "AED 1,049", note: "Liquid Retina LCD" },
              { model: "iPad Air M2 13″ (2024)",             ours: "AED 800",   apple: "AED 1,149", note: "Larger 13″ panel" },
              { model: "iPad Air M3 11″ / 13″ (2025)",      ours: "AED 720–820", apple: "AED 1,099–1,199", note: "M3, same Liquid Retina LCD" },
              { model: "iPad Pro 11″ M1 / M2 (2021–2022)",  ours: "AED 850",   apple: "AED 1,299", note: "Liquid Retina XDR mini-LED" },
              { model: "iPad Pro 11″ M4 (2024)",            ours: "AED 950",   apple: "AED 1,399", note: "Ultra Retina XDR OLED (tandem)" },
              { model: "iPad Pro 11″ M5 (2025)",            ours: "AED 1,000", apple: "AED 1,499", note: "OLED, thinnest iPad ever" },
              { model: "iPad Pro 12.9″ / 13″ M1–M2 (2021–2022)", ours: "AED 1,000", apple: "AED 1,599", note: "Liquid Retina XDR mini-LED" },
              { model: "iPad Pro 13″ M4 (2024)",            ours: "AED 1,100", apple: "AED 1,699", note: "Ultra Retina XDR OLED (tandem)" },
              { model: "iPad Pro 13″ M5 (2025)",            ours: "AED 1,200", apple: "AED 1,799", note: "Largest OLED panel Apple makes" },
            ]}
          />
          ...
          <h2>Why iPad screen costs vary so much — LCD vs mini-LED vs OLED</h2>
          <p>
          ...
          <h2>Cracked glass only — do you need a full screen replacement?</h2>
          <p>
          ...
          <p>
            For entry iPads and iPad minis, the full-panel replacement at AED 450–580 is cheaper
            than the labour to separate and re-bond glass alone. We tell you which applies to your
            model before any work starts.
          </p>

          <h2>Apple Store vs independent repair — honest comparison</h2>
          <p>
          ...
          <h2>What the iPad screen repair includes</h2>
          ...
          <h2>How to get your iPad screen repaired in Dubai</h2>
          <p>
