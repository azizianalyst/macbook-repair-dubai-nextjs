  ...
  return (
    <SubServicePageTemplate
      ...
      faqs={[
        ...
        { q: "Will macOS Ventura/Sonoma run on a 2012 MacBook Pro with 16GB?", a: "Officially no - those are too old for current macOS. We can install OpenCore Legacy Patcher to run modern macOS unofficially - a separate quoted service. Or stay on the latest officially-supported macOS for that machine (Big Sur on 2012)." },
      ]}
