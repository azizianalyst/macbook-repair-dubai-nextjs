  ...
  return (
    <BlogPostTemplate
      ...
      toc={[
        ...
        { id: "device-port-reference", label: "Device port reference" },
        { id: "usb-c-speeds", label: "USB-C speeds" },
        { id: "charging-speeds", label: "Charging speeds" },
        { id: "magsafe", label: "What about MagSafe" },
        { id: "cable-buying-advice", label: "Cable buying advice" },
        { id: "lightning-ports-repair", label: "Lightning ports we repair" },
        { id: "usb-c-ports-fail", label: "USB-C ports also fail" },
      ]}
      ...
      readingMinutes={9}
      featuredImageAlt="Lightning Vs Usb-c Explained. Lightning vs USB-C on iPhone - 2026 transition status guide"
      body={
        <>
          <h2 id="how-we-got-here">Lightning Vs Usb-c Explained. How we got here - quick history</h2>
          ...
          <h2 id="device-port-reference">Which Apple devices in 2026 use which port?</h2>
          <BlogPriceTable
          ...
          <h2 id="usb-c-speeds">USB-C speeds - not all USB-C is equal</h2>
          <ul className="list-disc list-inside space-y-xs">
          ...
          <h2 id="charging-speeds">Charging speeds across the lineup</h2>
          <ul className="list-disc list-inside space-y-xs">
          ...
          <h2 id="magsafe">What about MagSafe?</h2>
          <p>
          ...
          <h2 id="usb-c-ports-fail">USB-C ports also fail</h2>
          <p>
