...
const COMPARISON: { factor: string; apple: string; aasp: string; us: string }[] = [
  ...
  { factor: "Warranty on the repair",
    apple: "12 months",
    aasp: "12 months (or remaining Apple cover)",
    us: "12-month written warranty + 3-month battery cover" },
  { factor: "Turnaround",
...
export default function WhereToRepairMacBookDubai() {
  return (
    <SubServicePageTemplate
      ...
      seoDescription="Apple Store vs Authorised Service Provider vs independent specialist — an honest, priced guide to MacBook repair in Dubai. When each route wins, with real AED prices and a 12-month warranty."
      ...
      steps={[
        ...
        { title: "Return + 12-month warranty",     body: "Free return delivery with a written 12-month warranty on the repair (3 months on batteries)." },
      ]}
      warrantyDays={365}
      warrantyBullets={[
        "12-month written warranty on the replaced part and the workmanship.",
        "3-month cover on battery replacements.",
      ...
      faqs={[
        ...
        { q: "Do you use genuine Apple parts?", a: "We use genuine parts where they're available and high-grade OEM-spec parts where they aren't - and we tell you which your repair uses before we start. Both carry our 12-month written warranty." },
      ...
      related={[
        ...
        { label: "12-month warranty",                href: "/warranty",                        description: "Exactly what our written warranty covers." },
      ]}
