...
const COMPARISON: { factor: string; apple: string; aasp: string; us: string }[] = [
  ...
  { factor: "Warranty on the repair",
    ...
    us: "written warranty up to 12 months + 3-month battery cover" },
  { factor: "Turnaround",
...
export default function WhereToRepairMacBookDubai() {
  return (
    <SubServicePageTemplate
      ...
      seoDescription="Apple Store vs Authorised Service Provider vs independent specialist, an honest, priced guide to MacBook repair in Dubai. When each route wins, with real AED prices and a warranty of up to 12 months."
      ...
      steps={[
        ...
        { title: "Return + warranty of up to 12 months",     body: "Free return delivery with a written warranty of up to 12 months on the repair (3 months on batteries)." },
      ]}
      warrantyDays={365}
      warrantyBullets={[
        "written warranty up to 12 months on the replaced part and the workmanship.",
      ...
      related={[
        ...
        { label: "warranty of up to 12 months",                href: "/warranty",                        description: "Exactly what our written warranty covers." },
      ]}
