...
export default function MacBookProM1BatteryReplacement() {
  return (
    <MacBookProChipBatteryPage
      ...
      chip="M1"
      years="2021"
      seoTitle="MacBook Pro M1 Battery Replacement Dubai"
      seoDescription="MacBook Pro M1 Pro/Max battery replacement Dubai. 69.6 Wh (14-inch) and 99.6 Wh (16-inch). BMS re-pair included. Same-day 2-hour service. Call 055 741 3706."
      ...
      heroAnswer="MacBook Pro M1 battery replacement in Dubai is quoted per size after a free diagnosis at MacBook Repair Dubai — the 14-inch and 16-inch take different cells. The M1 Pro uses a 69.6 Wh cell; the M1 Max 16-inch uses a 99.6 Wh cell — both rated for 1,000 cycles. All Apple Silicon MacBook Pro battery replacements require BMS firmware re-pair, which is included in the price. Same-day 2-hour service."
      chipUniquePoints={[
        "MacBook Pro M1 Pro 14-inch uses a 69.6 Wh cell; the M1 Max 16-inch uses the larger 99.6 Wh pack that gives up to 21 hours battery life. The M1 Max is very worth servicing — the battery is the only weak point on an otherwise powerful machine.",
      ...
      faults={[
        {
          ...
          body: "System Settings shows Service Recommended when capacity drops below 80 percent or cycle count passes 1,000. M1 Pro machines bought in 2021 are frequently reaching this threshold in 2025, especially those used for heavy workloads such as video editing or Xcode. Battery replacement restores full status.",
        },
        {
          title: "Sudden shutdown at 20 to 30 percent",
          body: "Premature shutdown means the BMS can no longer accurately read cell voltage as the pack ages. The protection circuit cuts power before the display percentage reaches zero. This is confirmed with the coconutBattery app. Fix is battery replacement plus BMS re-pair on the 14-inch.",
        },
        {
        ...
        },
        {
          ...
          body: "The 69.6 Wh cell on the 14-inch can swell if kept near full charge for extended periods at high ambient temperature, which is common in Dubai offices. A swollen cell lifts the trackpad or bows the bottom case. Stop using it immediately and WhatsApp us for same-day pickup. Replacement before the trackpad cracks.",
        },
      ]}
      faqs={[
        {
          q: "How much does MacBook Pro M1 battery replacement cost in Dubai?",
          a: "MacBook Pro M1 battery replacement is quoted per size after a free diagnosis — the 14-inch M1 Pro and 16-inch M1 Max take different cells. Both prices include the new cell, BMS firmware re-pair, labour, and a 3-month written warranty. No diagnostic fee.",
        },
        {
        ...
        },
        {
          ...
          a: "The 14-inch M1 Pro uses a 69.6 Wh cell rated for up to 17 hours of battery life. The 16-inch M1 Max uses a larger 99.6 Wh cell rated for up to 21 hours. Both use the same MagSafe 3 and Thunderbolt 4 charging ports. Replacement is quoted per size, 14-inch and 16-inch differing.",
        },
      ]}
