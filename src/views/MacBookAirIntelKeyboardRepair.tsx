...
export default function MacBookAirIntelKeyboardRepair() {
  return (
    <MacBookAirChipKeyboardPage
      ...
      faults={[
        ...
        },
        {
          ...
          body: "Liquid on a butterfly keyboard dries under the mechanism and bonds the wings. Because butterfly keys cannot be removed individually, top-case replacement is required. If significant liquid reached the logic board, we check that too — free as part of diagnosis.",
        },
        {
        ...
        },
        {
          ...
          body: "If the full backlight is dead (not just one zone), the backlight flex cable between the top-case and logic board has failed. New top-case includes a new backlight array. If the logic board connector is damaged, we address that separately.",
        },
        {
          title: "All keys unresponsive after macOS update",
          body: "Rare but reported after major macOS upgrades on Intel Air. Usually a SMC firmware issue rather than hardware. We test software reset first (SMC + PRAM). If reset does not restore function, the keyboard flex connector needs inspection.",
        },
      ]}
      faqs={[
        {
        ...
        },
        {
          ...
          a: "Apple's butterfly mechanism is integrated into the aluminium top-case backplate and cannot be serviced independently. Individual butterfly keys cannot be removed or replaced. The only repair option is replacing the full top-case assembly — which includes the keyboard, trackpad, and battery. MacBook Repair Dubai carries these assemblies in stock.",
        },
        {
        ...
        },
        {
          ...
          a: "Compressed air can temporarily clear debris from under a key, which may restore function for a short time. However, it does not fix the butterfly mechanism itself — if the mechanism has deformed or been contaminated with liquid residue, top-case replacement is the only permanent fix.",
        },
        {
          q: "Will my data be safe during keyboard (top-case) replacement?",
          a: "Yes. Top-case replacement does not involve the SSD or logic board. Your data is completely unaffected. The SSD on Intel Air models is on a separate card soldered to the logic board and stays in place throughout the repair.",
        },
      ]}
      blogHref="/blog/macbook-pro-butterfly-keyboard-failing-dubai"
      blogLabel="MacBook Butterfly Keyboard Failing Dubai — Dust Fix and Repair Cost"
