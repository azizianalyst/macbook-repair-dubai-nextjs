...
export default function BlogMacBookRepairWarrantyExplained() {
  return (
    <BlogPostTemplate
      seoTitle="MacBook Repair Warranty Explained: Dubai 2026 (12-Month Flat Cover)"
      seoDescription="Exactly what our 12-month MacBook repair warranty covers, what isn't covered, how to claim, and how it compares to Apple's warranty and AppleCare+."
      path="/blog/macbook-repair-warranty-explained"
      category="Trust · Warranty"
      h1="MacBook Repair Warranty Explained - Dubai 2026"
      hook="12-month warranty on every repair. Here's exactly what's covered (and what isn't)."
      quickAnswer="Every MacBook repair we do carries a 12-month workmanship + parts warranty (3 months on batteries). It covers the part we replaced and the work we did. It does not cover new physical damage, new liquid spills, or unrelated failures. Bring the receipt to claim - same-day re-service in most cases."
      ...
      body={
        <>
          <h2>Quick answer</h2>
          <p>
            Our standard MacBook repair warranty is <strong>12 months</strong> on the specific component
            we replaced and the workmanship around it. Batteries get a <strong>3-month</strong>{" "}
          ...
          <h2>What our 12-month warranty covers</h2>
          ...
          <BlogPriceTable
            ...
            headers={["Aspect", "Apple 1-year warranty", "Our 12-month warranty"]}
            rows={[
              { model: "Duration", apple: "12 months from purchase", ours: "12 months from repair (3 months batteries)" },
          ...
          <h2>Battery warranty (3 months)</h2>
          <p>
          ...
          <p>
            ...
            months - which is why 12 months is comfortable for us, and why our re-service rate is under
            2% of jobs.
          </p>
      ...
      faqs={[
        ...
        { q: "How is your warranty better than Apple Service Center for out-of-warranty MacBooks?", a: "Apple's out-of-warranty repair carries a 12-month warranty too - same duration as ours. The difference is price (we're typically 50-70% of Apple's quote), turnaround (same-day vs 5-10 days), and pickup service. The warranty itself is comparable." },
      ]}
      relatedLinks={[
