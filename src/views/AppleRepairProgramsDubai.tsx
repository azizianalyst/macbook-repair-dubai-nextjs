...
const FAQS = [
  ...
  { q: "What happens if Apple refuses my programme repair?",
    a: "Common reasons: serial number outside the eligible range, accidental damage flagged by Apple's diagnostic, or the programme has expired. In any of those cases bring the device back to us - we can repair the same fault out-of-pocket with transparent pricing and a 90-day warranty, often the same day." },
...
const SCENARIOS = [
  { q: "MacBook Pro 2018 sticking keyboard.",
    a: "Apple's Keyboard Service Programme has now ended for most 2018 models. We replace the full top case (keyboard + battery + trackpad) for AED 700, 90-day warranty, 1-2 day turnaround." },
  { q: "iPhone 11 touch unresponsive.",
    a: "Programme ended September 2022. We replace the display module from AED 500, 60-90 minutes in the workshop, 90-day warranty." },
  { q: "13\" MacBook Pro 2016 backlight stripes (Flexgate).",
    a: "Programme ended 2021. Cable-only repair AED 600; full display AED 800. Both with 90-day warranty." },
  { q: "iPhone 12 receiver dead during calls.",
    a: "Programme ended March 2023. Receiver replacement AED 350 with 90-day warranty, returned same day." },
];
