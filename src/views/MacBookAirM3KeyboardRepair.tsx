...
export default function MacBookAirM3KeyboardRepair() {
  return (
    <MacBookAirChipKeyboardPage
      ...
      chipUniquePoints={[
        ...
        "The M3 Air added a Sky Blue colour option. Sky Blue uses the same anodisation process as Midnight and is similarly subject to surface wear on high-contact areas over time. At 1–2 years, this is not yet visible on most machines. Key caps for Sky Blue M3 Air are colour-matched — we source the correct colour set.",
        "M3 Air supports dual external displays simultaneously (lid closed). Users frequently attaching and detaching from dock setups with the lid open may stress the keyboard flex cable routing. If you hot-dock frequently, check the area near the keyboard connector if multiple keys start failing — it is uncommon but worth diagnosing before replacing individual key caps.",
        "The M3 Air's keyboard repair process is identical to M2 — individual scissor key replacement for isolated faults, full top-case with original Touch ID transfer for multiple key failures or flex damage. Turnaround same-day for both 13-inch and 15-inch.",
      ]}
      prices={[
        {
          model: 'MacBook Air 13" M3 (2024) — individual key',
          price: 300,
          applePrice: null,
        ...
        {
          model: 'MacBook Air 13" M3 (2024) — full top-case',
          price: 490,
          applePrice: 549,
        ...
        {
          model: 'MacBook Air 15" M3 (2024) — individual key',
          price: 320,
          applePrice: null,
          timeline: "Same day · 30–60 min",
        ...
        {
          model: 'MacBook Air 15" M3 (2024) — full top-case',
          price: 530,
          applePrice: 599,
          timeline: "Same day · 2–3 hours",
          l4href: "/macbook-air-15-m3-2024-repair-dubai",
      ...
      faults={[
        ...
        },
        {
          ...
          body: "Usually a software calibration issue — go to System Settings > Touch ID and re-enrol your fingerprints. If the sensor physically stopped working or the button is cracked, replacement is required. We source genuine M3 Air Touch ID button assemblies. Transfer is included if top-case replacement is needed.",
        },
        {
        ...
        },
        {
          ...
          body: "Backlight unevenness under specific keys points to a delaminated backlight strip. This can be repaired by replacing the backlight element under the affected area as part of a keyboard service. Full backlight failure is typically a logic board connector issue — diagnosed for free.",
        },
      ]}
      faqs={[
        {
        ...
        },
        {
          ...
          a: "The scissor-switch mechanism and key travel are identical. The chassis dimensions are the same, so top-case assemblies are similar in size. However, M3 Air top-case assemblies have M3-specific internal routing and should use M3 Touch ID buttons — we do not cross-fit M2 parts into M3 chassis.",
        },
        {
        ...
        },
        {
          ...
          a: "Individual key replacement: 30–60 minutes, same-day. Full top-case replacement: 2–3 hours, same-day. Drop off at our Dubai Media City workshop before 11am, collect same afternoon.",
        },
      ]}
