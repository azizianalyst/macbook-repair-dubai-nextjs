...
export default function MacBookSpeakerRepair() {
  return (
    <SubServicePageTemplate
      ...
      subtitle="Crackling at high volume, no sound from one side, distortion that wasn't there before. Speaker drivers are replaceable on every MacBook - same-week, quoted in writing first."
      startingPrice={400}
      timeline="1 day"
      ...
      serviceName="MacBook Speaker Repair Dubai"
      intro={
        <>
          <p className="text-[18px] leading-relaxed mb-md">
            <strong>MacBook speaker repair in Dubai</strong> covers blown drivers (cone damage from sustained high-volume use), distortion at the top of the volume range (voice coil rubbing), no sound from one side (failed driver or cable), and water-damaged speaker assemblies (corrosion on the contacts). On 2016+ MacBook Pros the speakers are bonded to the top case but the drivers themselves are replaceable. The quoted price covers parts, labour and a warranty of up to 12 months.
          </p>
      ...
      faqs={[
        ...
        { q: "Can you fix the audio jack at the same time?", a: "Yes. Headphone jack repair shares the same disassembly, so doing both together costs meaningfully less than two separate jobs - we quote the package in writing." },
      ...
      related={[
        ...
        { label: "MacBook Water Damage Repair",   href: "/macbook-water-damage-repair-dubai",     description: "Liquid kills speakers first. Quoted after the free diagnosis." },
