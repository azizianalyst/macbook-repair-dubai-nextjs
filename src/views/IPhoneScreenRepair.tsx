  ...
  return (
    <IPhonePageTemplate
      ...
      steps={[
        ...
        { title: "Free delivery + warranty up to 3 months", body: "Same day on iPhone 6 to iPhone 16. Next day on iPhone 17 line. Warranty card lists panel batch - covers manufacturing defects and post-repair touch failure." },
      ]}
      warrantyDays={90}
      glassNotice
      warrantyBullets={[
        ...
        "Warranty depends on the panel grade: genuine Apple OLED carries a 3-month workshop warranty (plus Apple's own 1-year warranty when sourced from an authorised distributor); high-grade A-grade aftermarket panels carry 15 days - the grade is confirmed on every quote.",
      ]}
      comparisonRows={[
