...
export default function IPhoneWaterDamageRepair() {
  return (
    <IPhonePageTemplate
      seoTitle="iPhone Water Damage Repair Dubai - Ultrasonic Clean | From AED 179"
      seoDescription="iPhone water damage repair Dubai from AED 179. Ultrasonic clean, corrosion removal, 24-hour window matters. iPhone 6 to 17. WhatsApp 055 741 3706 now."
      ...
      problems={[
        { title: "Phone fell in the pool, screen now black", body: "Backlight short or display flex corroded. Same-day clean + flex inspection. AED 179 to AED 700 depending on model. Don't try to charge - that's how the logic board dies." },
        { title: "Coffee or juice spill - sticky residue inside", body: "Sugar conducts when wet. Ultrasonic bath in 99% isopropyl removes residue cleanly. AED 179 to AED 700 same day. Sweet drinks are worse than plain water." },
      ...
      faqs={[
        { q: "How much does iPhone water damage repair cost in Dubai?", a: "From AED 179 for a clean-only on older iPhones. AED 450 to AED 700 if light corrosion needs reflowing. AED 850 for iPhone 16/17 because the Apple Silicon BGA work is more complex. Sea water treatment is AED 950 across all models. No-fix-no-charge applies - only AED 100 diagnostic if the phone can't be saved." },
