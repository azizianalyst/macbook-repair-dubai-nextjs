...
export default function BlogIPhoneAirEngineering() {
  return (
    <BlogPostTemplate
      ...
      seoDescription="iPhone Air is 5.5mm thick, Apple's thinnest. Inside: titanium chassis, single-camera tradeoff, smaller battery and repair complexity. Dubai service - WhatsApp for a quote."
      ...
      quickAnswer="iPhone Air (September 2025) is 5.5mm thick and weighs 165g, Apple's thinnest 6.6-inch iPhone. The tradeoffs: a titanium-grade-5 unibody, a single 48 MP rear camera, a smaller 3,150 mAh battery, and a tighter layout that adds 20-30% to repair complexity. For screen, battery or back-glass repair in Dubai, message us on WhatsApp for today's exact price on your model."
      ...
      body={
        <>
          ...
          <BlogPriceTable
            caption="iPhone Air - repairs at our Media City workshop (message us for pricing)"
            headers={["Repair", "Apple Store UAE", "Our price", "Turnaround"]}
            rows={[
              { model: "Screen replacement", ours: "Price on request", apple: "Price on request", note: "60-90 min" },
              { model: "Battery replacement", ours: "Price on request", apple: "Price on request", note: "75 min" },
              { model: "Back glass repair", ours: "Price on request", apple: "Price on request (chassis swap)", note: "Same day" },
              { model: "Camera replacement", ours: "Price on request", apple: "Price on request", note: "60 min" },
              { model: "Charging port (USB-C)", ours: "Not offered", apple: "Price on request", note: "Same day" },
              { model: "Water damage diagnostic", ours: "Not offered", apple: "Price on request", note: "24-72 hr" },
            ]}
          />
      ...
      faqs={[
        ...
        { q: "How much does an iPhone Air cost new in Dubai?", a: "The iPhone Air ships in 256GB, 512GB and 1TB configurations at Apple Store UAE (April 2026), with a used 256GB market on Dubizzle. For repair pricing on any model, message us on WhatsApp for today's exact quote." },
      ]}
      relatedLinks={[
