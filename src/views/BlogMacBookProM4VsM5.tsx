  ...
  return (
    <BlogPostTemplate
      ...
      toc={[
        ...
        { id: "benchmarks", label: "Real-world benchmarks" },
        { id: "battery", label: "Battery life" },
        { id: "display", label: "Display: exactly the same" },
        { id: "price", label: "Price difference in Dubai" },
        { id: "resale", label: "Resale value of M4" },
        { id: "verdict", label: "Verdict by user type" },
      ]}
      ...
      readingMinutes={11}
      featuredImageAlt="MacBook Pro M4 vs M5 worth upgrade comparison Dubai 2026"
      body={
        <>
          ...
          <h2 id="spec-comparison">Spec-by-spec: MacBook Pro 14″</h2>
          <BlogPriceTable
            caption="MacBook Pro 14″ M4 vs M5 - base configuration, June 2026"
          ...
          <h2 id="benchmarks">Real-world benchmarks</h2>
          <p>
          ...
          <h2 id="battery">Battery life: M5 wins by an hour</h2>
          <p>
