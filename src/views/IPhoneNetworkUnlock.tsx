...
export default function IPhoneNetworkUnlock() {
  return (
    <IPhonePageTemplate
      seoTitle="iPhone Network Unlock Dubai - Carrier Unlock via IMEI"
      seoDescription="iPhone network unlock Dubai. Legitimate carrier unlock via IMEI. UAE, US, UK carriers supported. No jailbreak. Permanent. WhatsApp 055 741 3706 for your price."
      ...
      intro={
        <>
          <p className="text-[17px] text-text leading-relaxed">
            iPhone network unlock in Dubai starts with a free IMEI status check on a clean Etisalat or du IMEI - message us on WhatsApp for today's exact price on your carrier. The unlock is legitimate, IMEI-based, and registered in Apple's GSX database - meaning the iPhone shows as "Unlocked" in Apple's records permanently. It survives iOS updates, factory erases, and SIM swaps. There's no jailbreak involved, no fake unlock app, no R-SIM hardware bypass. The workshop has been processing IMEI unlocks since 2014, working through Apple-authorised partners and carrier portals in the UAE, US, UK, EU, Japan, and Korea.
          </p>
      ...
      honestyCallout={
        <div className="text-[15px] text-text leading-relaxed space-y-md">
          <p>
            <strong>What we don't do:</strong> jailbreak unlocks, R-SIM hardware unlocks, fake software unlocks. These are temporary, illegal in many jurisdictions, void Apple's warranty, can brick the phone after an iOS update, and often resurface as locked again. If a Dubai shop offers a suspiciously cheap "unlock" with no IMEI involved, walk away - it's a software or SIM-tray trick that will fail.
          </p>
          <p>
      ...
      problems={[
        { title: "Bought iPhone in the US, locked to AT&T, want to use du SIM", body: "Most common ticket. AT&T unlock if the contract is paid off - 1-5 days, permanent. Free IMEI check first to confirm contract status, then message us for the exact price." },
        { title: "Locked to Etisalat from a postpaid contract", body: "Etisalat lets postpaid customers unlock their own device for free after the contract ends. The workshop helps with the application if you don't want to deal with the call centre. 1-3 days - message us for your price." },
        { title: "T-Mobile USA unlock for travelling abroad", body: "T-Mobile unlocks once the device is paid off and the line has been active for 40+ days. Workshop processes the request via official channels. 2-5 days - WhatsApp us for the exact price." },
        { title: "Sprint / Boost iPhone - hard to unlock", body: "Sprint policy is the strictest. Workshop has access to premium IMEI unlock channels but pricing is higher (3-7 days). Not all Sprint IMEIs are eligible - free check first, then we confirm the price." },
        ...
        { title: "No SIM available message", body: "Not always a network lock - sometimes a SIM tray issue (a quick tray swap) or Lightning/USB-C port damage near the modem antenna. Free diagnosis confirms hardware vs lock." },
        ...
        { title: "Japan SoftBank / KDDI / NTT Docomo iPhone", body: "Japanese carriers unlock for free for the original owner via their app. Workshop helps with the process for non-Japanese-speaking customers. 3-7 days when the workshop submits on the customer's behalf - message us for the price." },
      ]}
      steps={[
      ...
      comparisonRows={[
        ...
        ["Etisalat UAE - paid postpaid", "Price on request, with paperwork help",          "Free if you call carrier directly"],
        ["AT&T USA",                     "Price on request, 1-5 days",                     "Free if you're the AT&T account holder"],
        ["Sprint USA",                   "Price on request, 3-7 days",                     "Often refused for non-account-holder"],
      ...
      faqs={[
        { q: "How much does iPhone network unlock cost in Dubai?", a: "It depends on the carrier - clean Etisalat, du, or Verizon IMEIs are the most affordable, with AT&T, UK carriers, T-Mobile, Sprint, Japan, and Korea priced higher by carrier policy. Blacklisted IMEIs cannot be unlocked at any price. Free IMEI status check first, then message us on WhatsApp for today's exact price." },
        ...
        { q: "What if my iPhone is from Japan or Korea?", a: "Japan SoftBank, KDDI, and NTT Docomo can be unlocked for free directly through the carrier's app - the workshop helps with the process for non-Japanese-speaking customers. Typically 3-7 days; message us on WhatsApp for the exact price. Korean carriers are similar." },
      ]}
