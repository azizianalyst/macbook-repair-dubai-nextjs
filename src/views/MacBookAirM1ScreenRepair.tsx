...
export default function MacBookAirM1ScreenRepair() {
  return (
    <MacBookAirChipScreenPage
      ...
      resolution="2560×1600 (13.3-inch)"
      trueTone={false}
      p3={false}
      brightness="400 nits"
      ...
      faults={[
        ...
        },
        {
          ...
          body: "Liquid that enters through the USB-C ports or keyboard can travel along the display cable and corrode the connector. We clean the cable connector at component level before installing a new panel — skipping the cleaning step means the new panel fails on the same corrosion within weeks.",
        },
      ]}
      faqs={[
        {
        ...
        },
        {
          ...
          a: "No. True Tone was not included in the MacBook Air M1 (2020). It was introduced on the Air with the M2 generation in 2022. If you do not see True Tone in System Settings on an M1 Air, that is expected — it is not a screen fault.",
        },
        {
          q: "Is the MacBook Air M1 screen the same as the MacBook Air M2 screen?",
          a: "No. The M1 Air uses an IPS Retina panel at 13.3 inches, 2560x1600 resolution, and 400 nits with no True Tone. The M2 Air uses a Liquid Retina panel at 13.6 inches, 2560x1664 resolution, 500 nits, with True Tone and P3 wide colour. Parts are completely different.",
        },
        {
        ...
        },
        {
          ...
          a: "Same-day at MacBook Repair Dubai. Drop off before 11am, collect by 4pm. We stock M1 Air IPS Retina panels. The bench repair takes 60–90 minutes.",
        },
        {
