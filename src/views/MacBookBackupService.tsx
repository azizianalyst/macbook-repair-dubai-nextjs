...
export default function MacBookBackupService() {
  return (
    <SubServicePageTemplate
      ...
      seoDescription="MacBook backup service in Dubai. Time Machine setup, data migration to a new Mac or external drive, full backup before any repair. Free diagnosis."
      path="/macbook-backup-service-dubai"
      eyebrow="Backup & data safety"
      h1="MacBook Backup Service in Dubai"
      subtitle="Time Machine set up properly, data moved to a new Mac or drive, and a full backup taken before any repair so nothing's lost. Most done same day."
      startingPrice={150}
      timeline="Same day"
      ...
      faqs={[
        { q: "How much is a MacBook backup service in Dubai?", a: "The simplest job is a Time Machine setup with a verified first backup. Data migration to a new Mac is usually the same band; a full pre-repair backup is included free when we're already repairing the machine. We quote on WhatsApp once you tell us how much data and where it's going." },
        { q: "What's the difference between backup and data recovery?", a: "Backup is copying files you can still see, so you're safe if the Mac later fails. Recovery is pulling back files that are already deleted, on a dead drive, or on a Mac that won't boot. This page is backup. For lost or unreachable files see our data recovery page in Dubai." },
        ...
        { q: "Time Machine or cloud backup - which should I use?", a: "Both, ideally. Time Machine on a local drive restores a whole Mac fast and works offline. iCloud or a cloud copy survives theft, fire or a lost drive. We set up a local Time Machine and can layer cloud on top so you've got two copies in two places." },
        ...
        { q: "Do you collect the MacBook or do I bring it in?", a: "Either. Free pickup and delivery across Dubai mainland, or drop it at Concord Tower, Media City, 9am to 10pm. Pickup to Sharjah and Abu Dhabi carries a trip charge, confirmed before we dispatch. WhatsApp 055 741 3706 and we'll arrange a time." },
      ...
      related={[
        { label: "MacBook Data Recovery",        href: "/macbook-data-recovery-dubai",          description: "Deleted files, dead drive, won't boot." },
      ...
      quickAnswer={{
        ...
        answer: "MacBook Repair Dubai sets up Time Machine, migrates data to a new Mac or external drive, and takes a full backup before any repair. Most jobs finish the same day, your data stays confidential, and we offer free pickup across Dubai mainland.",
      }}
    />
  );
}
