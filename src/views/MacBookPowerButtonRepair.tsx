...
export default function MacBookPowerButtonRepair() {
  return (
    <SubServicePageTemplate
      ...
      subtitle="Power button dead, stuck, or Touch ID won't read your fingerprint? We repair and replace MacBook power/Touch ID assemblies - most done same day, written quote first."
      startingPrice={250}
      ...
      related={[
        ...
        { label: "MacBook Water Damage Repair", href: "/macbook-water-damage-repair-dubai", description: "Spill corroded the button? Board repair quoted after diagnosis." },
      ]}
    />
  );
}
