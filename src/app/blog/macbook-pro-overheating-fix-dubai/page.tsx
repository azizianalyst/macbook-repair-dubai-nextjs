...
export const metadata: Metadata = {
  ...
  description: "MacBook Pro overheating fix in Dubai? 6 causes, CPU throttling, fan clog, thermal paste, Dubai heat damage, with step-by-step solutions. Message us on WhatsApp.",
  openGraph: {
    title: "MacBook Pro Overheating Fix Dubai: M1 to M5 Guide 2026",
    description: "MacBook Pro running hot in Dubai? 6 causes diagnosed step-by-step. Thermal paste service same day — message us on WhatsApp.",
  ...
  twitter: {
    ...
    title: "MacBook Pro Overheating Fix Dubai: M1 to M5 Guide 2026",
    description: "6 causes diagnosed step-by-step. Thermal paste service in Dubai — message us on WhatsApp.",
