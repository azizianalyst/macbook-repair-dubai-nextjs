...
export const metadata: Metadata = {
  ...
  description: "MacBook Air M2 problems in Dubai: SSD degradation, overheating, hinge crack, MagSafe 3. All M2 Air faults fixed fast. Free diagnosis, same-day service.",
  openGraph: {
    title: "MacBook Air M2 Common Problems Dubai: 13-inch & 15-inch Fix Guide 2026",
    description: "MacBook Air M2 problems? SSD wear, battery swelling, hinge crack, MagSafe. Fix guide plus WhatsApp us for a quote. Free diagnosis in Dubai.",
