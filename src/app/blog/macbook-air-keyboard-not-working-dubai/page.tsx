...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      url: "https://macbook-repair-dubai.ae/images/real/lab/macbook-keyboard-repair-dubai-desktop.avif",
      width: 1600,
      height: 900,
  ...
  twitter: {
    ...
    images: ["https://macbook-repair-dubai.ae/images/real/lab/macbook-keyboard-repair-dubai-desktop.avif"],
  },
  alternates: {
