...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "MacBook Pro Not Charging? Fix Guide Dubai 2026",
    description: "MacBook Pro not charging in Dubai? 6 causes diagnosed step-by-step. Same-day charging repair, message us on WhatsApp for a quote.",
  ...
  twitter: {
    ...
    title: "MacBook Pro Not Charging? Fix Guide Dubai 2026",
    description: "6 causes diagnosed step-by-step. Same-day charging repair in Dubai, message us for a quote.",
