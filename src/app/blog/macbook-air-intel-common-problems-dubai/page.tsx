...
export const metadata: Metadata = {
  ...
  description: "MacBook Air Intel problems Dubai: butterfly keyboard, battery at 5+ years, screen backlight, USB-C charging. 2017-2020 models fixed. Free diagnosis.",
  openGraph: {
    title: "MacBook Air Intel Common Problems Dubai: 2017 to 2020 Fix Guide 2026",
    description: "MacBook Air Intel 2017-2020 problems? Butterfly keyboard, battery, backlight, USB-C. Fix guide plus WhatsApp pricing. Free diagnosis in Dubai.",
