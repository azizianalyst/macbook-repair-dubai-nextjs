...
export const metadata: Metadata = metaFromFields("/imac-intel-repair-dubai", {
  ...
  description: "iMac Intel repair Dubai. 21.5-inch Retina 4K (2017-2019), 27-inch 5K Retina (2017-2020), iMac Pro 27-inch (2017). Screen, logic board, PSU, GPU, SSD upgrade. Free diagnosis. Call 055 741 3706.",
});
