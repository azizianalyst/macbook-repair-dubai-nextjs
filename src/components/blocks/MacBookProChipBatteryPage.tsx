...
const HERO_IMG = {
  ...
  alt: "MacBook Pro battery replacement at MacBook Repair Dubai, Dubai Media City workshop",
};
  ...
  return (
    <div className="flex flex-wrap gap-sm">
      <Button asChild variant="whatsapp" size="lg">
        <a
          href={`${NAP.whatsappUrl}?text=${encodeURIComponent("Hi, MacBook Pro battery replacement quote please. Model: ")}`}
          target="_blank"
      ...
      <div className="-mb-[4rem] bg-bg text-text">
        ...
        <div className="pt-[64px]" style={{ borderBottom: "1px solid var(--color-border)" }}>
          <div className="mx-auto max-w-content px-5 md:px-6 py-[6px]">
            <BreadcrumbTrail tone="dark" trail={[
              ...
              { name: "Battery Replacement", path: "/macbook-pro-battery-replacement-dubai" },
        ...
        >
          <div className="mt-md" itemScope itemType="https://schema.org/Question">
            <p className="text-[15px] font-semibold text-text mb-2" itemProp="name">
              How much does MacBook Pro {chip} battery replacement cost in Dubai?
            </p>
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[80px]">
          <div className="text-center mb-[48px]">
            ...
            <h2 className="text-center text-[36px] md:text-[48px] font-bold tracking-tight text-text leading-[1.1]">
              MacBook Pro {chip} battery spec
            </h2>
            <p className="text-center mt-4 text-[16px] text-text-muted max-w-[54ch] mx-auto">
              The exact cells your {chip} Pro uses, and what that means for replacement.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: "14\" Capacity",  value: capacity14 },
              { label: "16\" Capacity",  value: capacity16 },
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[80px]">
          <div className="text-center mb-[48px]">
            ...
            <h2 className="text-center text-[36px] md:text-[48px] font-bold tracking-tight text-text leading-[1.1]">
              MacBook Pro {chip} battery replacement cost Dubai
            </h2>
        ...
        {/* WHAT MAKES THIS CHIP'S PRO BATTERY UNIQUE */}
        <section
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[96px]">
          <div className="text-center mb-[48px]">
            ...
            <h2 className="text-center text-[36px] md:text-[48px] font-bold tracking-tight text-text leading-[1.1]">
              MacBook Pro {chip} battery faults we repair
            </h2>
          </div>
          ...
          <div className="mx-auto max-w-content px-5 md:px-6">
            <div className="text-center mb-[48px]">
              ...
              <h2 className="text-center text-[32px] md:text-[44px] font-bold tracking-tight text-text leading-[1.1]">
                MacBook Pro {chip} battery replacement in Dubai
              </h2>
              <p className="text-center mt-4 text-[16px] text-text-muted max-w-[54ch] mx-auto">
            ...
            <div className="grid gap-x-xl gap-y-[40px] sm:grid-cols-2 lg:grid-cols-4">
              {[
                { Icon: Award,       title: "20+ years experience",     body: `We have replaced MacBook Pro batteries across every generation. Our technicians have deep experience with ${chip} Pro battery and BMS firmware re-pair.` },
                ...
                { Icon: Wrench,      title: "BMS re-pair on the bench", body: `Every ${chip} Pro battery swap includes BMS firmware re-pair using Apple diagnostic tools. Correct capacity readings from day one.` },
                { Icon: HardDrive,   title: "Data stays private",       body: "Your MacBook Pro is your business. We never access your data during battery replacements. Strict confidentiality on every job." },
              ].map(({ Icon, title, body }) => (
          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-10 items-start">
            <div className="lg:sticky lg:top-24 rounded-xl border border-border bg-bg-card p-6">
              ...
              <h2 className="text-[22px] font-bold tracking-tight text-text leading-snug mb-3">
                MacBook Pro {chip} battery questions
              </h2>
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[80px]">
          ...
          <div className="flex flex-wrap justify-center gap-sm text-[15px]">
            {[
              { label: "MacBook Pro battery replacement Dubai (all chips)", href: "/macbook-pro-battery-replacement-dubai" },
