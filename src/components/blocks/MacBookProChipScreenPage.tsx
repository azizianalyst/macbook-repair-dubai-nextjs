...
const HERO_IMG = {
  src: "/images/real/lab/macbook-pro-screen-repair.jpg",
  alt: "MacBook Pro screen repair at MacBook Repair Dubai, Dubai Media City workshop",
};
  ...
  return (
    <div className="flex flex-wrap gap-sm">
      <Button asChild variant="whatsapp" size="lg">
        <a
          href={`${NAP.whatsappUrl}?text=${encodeURIComponent("Hi, MacBook Pro screen repair quote please. Model: ")}`}
          target="_blank"
...
export default function MacBookProChipScreenPage({
  ...
  useSeo(
    ...
    [
      ...
      organization(),
      serviceSchema({
        name: `MacBook Pro ${chip} Screen Repair Dubai`,
        price: lowestPrice,
      ...
      <div className="-mb-[4rem] bg-bg text-text">
        ...
        <div className="pt-[64px]" style={{ borderBottom: "1px solid var(--color-border)" }}>
          <div className="mx-auto max-w-content px-5 md:px-6 py-[6px]">
            <BreadcrumbTrail tone="dark" trail={[
              ...
              { name: "Screen Repair", path: "/macbook-pro-screen-repair-dubai" },
        ...
        >
          <div className="mt-md" itemScope itemType="https://schema.org/Question">
            <p className="text-[15px] font-semibold text-text mb-2" itemProp="name">
              How much does MacBook Pro {chip} screen repair cost in Dubai?
            </p>
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[80px]">
          <div className="text-center mb-[48px]">
            ...
            <h2 className="text-center text-[36px] md:text-[48px] font-bold tracking-tight text-text leading-[1.1]">
              MacBook Pro {chip} screen spec
            </h2>
            <p className="text-center mt-4 text-[16px] text-text-muted max-w-[54ch] mx-auto">
              The exact panel your {chip} Pro uses and what that means for repair.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: "ProMotion",     value: promotionHz },
            ].map(({ label, value }) => (
              <div
                key={label}
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[80px]">
          <div className="text-center mb-[48px]">
            ...
            <h2 className="text-center text-[36px] md:text-[48px] font-bold tracking-tight text-text leading-[1.1]">
              MacBook Pro {chip} screen repair cost Dubai
            </h2>
          ...
          <p className="mt-md text-[13px] text-text-faint max-w-[72ch]">
            Warranty: 3 months. Genuine Apple panels or OEM equivalent. Free diagnosis.
          </p>
          ...
          <div className="mx-auto max-w-content px-5 md:px-6">
            <div className="text-center mb-[48px]">
              ...
              <h2 className="text-center text-[32px] md:text-[44px] font-bold tracking-tight text-white leading-[1.1]">
                What makes the {chip} Pro screen different
              </h2>
            </div>
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[96px]">
          <div className="text-center mb-[48px]">
            ...
            <h2 className="text-center text-[36px] md:text-[48px] font-bold tracking-tight text-text leading-[1.1]">
              MacBook Pro {chip} display faults we repair
            </h2>
          </div>
          ...
          <div className="mx-auto max-w-content px-5 md:px-6">
            <div className="text-center mb-[48px]">
              ...
              <h2 className="text-center text-[32px] md:text-[44px] font-bold tracking-tight text-text leading-[1.1]">
                MacBook Pro {chip} screen repair in Dubai
              </h2>
              <p className="text-center mt-4 text-[16px] text-text-muted max-w-[54ch] mx-auto">
                Independent Apple specialists since 2004. The faster, fairer-priced alternative.
              </p>
            </div>
            <div className="grid gap-x-xl gap-y-[40px] sm:grid-cols-2 lg:grid-cols-4">
              {[
                { Icon: Award,       title: "20+ years experience",       body: `We have repaired MacBook Pro screens since the first Retina model. Our technicians train on every new release including the ${chip}.` },
                { Icon: ShieldCheck, title: "Genuine panels",             body: "We use genuine Apple panels or OEM equivalent for every Liquid Retina XDR replacement. Panel grade is confirmed before you book." },
                { Icon: Wrench,      title: "No fix, no charge",          body: "You approve the quote before we start and inspect the repair before you pay. If we cannot fix it, you pay nothing." },
                { Icon: HardDrive,   title: "Data stays private",         body: "Your MacBook Pro is your business. We never access your data during screen replacements. Strict confidentiality on every job." },
              ].map(({ Icon, title, body }) => (
          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-10 items-start">
            <div className="lg:sticky lg:top-24 rounded-xl border border-border/70 bg-bg-card ring-1 ring-black/[0.03] p-6">
              ...
              <h2 className="text-[22px] font-bold tracking-tight text-text leading-snug mb-3">
                MacBook Pro {chip} screen repair — questions
              </h2>
        ...
        <section className="mx-auto max-w-content px-5 md:px-6 mt-[80px]">
          ...
          <div className="flex flex-wrap justify-center gap-sm text-[15px]">
            {[
              { label: "MacBook Pro screen repair Dubai (all chips)", href: "/macbook-pro-screen-repair-dubai" },
