...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        // text-base md:text-sm, matching Input: iOS Safari auto-zooms the whole
        // viewport when a focused control's font-size is under 16px. Textarea was
        // the one control on the lead form that missed this guard.
